...
# static fields
.field public static final M:Ljava/lang/String; = "ActionBarOverlayLayout"
...
.field public C:Ll1/x2;
    .annotation build Le/m0;
    .end annotation
.end field

.field public D:Ll1/x2;
    .annotation build Le/m0;
    .end annotation
.end field

.field public E:Ll1/x2;
    .annotation build Le/m0;
    .end annotation
.end field
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p2, Ll1/x2;->c:Ll1/x2;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->B:Ll1/x2;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->C:Ll1/x2;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->D:Ll1/x2;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->E:Ll1/x2;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z(Landroid/content/Context;)V

    new-instance p1, Ll1/y0;

    invoke-direct {p1, p0}, Ll1/y0;-><init>(Landroid/view/ViewGroup;)V

    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->L:Ll1/y0;
...
.method public E()V
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x(Landroid/view/View;)Lo/i0;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->l:Lo/i0;
...
.method public a(Landroid/view/Menu;Landroidx/appcompat/view/menu/j$a;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->l:Lo/i0;

    invoke-interface {v0, p1, p2}, Lo/i0;->a(Landroid/view/Menu;Landroidx/appcompat/view/menu/j$a;)V
...
.method public bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v()Landroidx/appcompat/widget/ActionBarOverlayLayout$e;
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w(Landroid/util/AttributeSet;)Landroidx/appcompat/widget/ActionBarOverlayLayout$e;
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->L:Ll1/y0;
...
.method public n(Landroid/util/SparseArray;)V
    ...
    invoke-interface {v0, p1}, Lo/i0;->G(Landroid/util/SparseArray;)V
...
.method public o(I)V
    ...
    :cond_1
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->l:Lo/i0;

    invoke-interface {p1}, Lo/i0;->S()V
...
.method public onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-virtual/range {v0 .. v6}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z

    move-result v0

    iget-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:Landroid/graphics/Rect;

    invoke-static {p0, p1, v1}, Ll1/j1;->o(Landroid/view/View;Ll1/x2;Landroid/graphics/Rect;)Ll1/x2;
    ...
    invoke-virtual {p1, v2, v3, v4, v1}, Ll1/x2;->x(IIII)Ll1/x2;

    move-result-object v1

    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->B:Ll1/x2;

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->C:Ll1/x2;

    invoke-virtual {v2, v1}, Ll1/x2;->equals(Ljava/lang/Object;)Z

    move-result v1

    if-nez v1, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->B:Ll1/x2;

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->C:Ll1/x2;
    ...
    :cond_2
    invoke-virtual {p1}, Ll1/x2;->a()Ll1/x2;
...
.method public onMeasure(II)V
    ...
    invoke-static {p0}, Ll1/j1;->C0(Landroid/view/View;)I
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->B:Ll1/x2;

    iput-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->D:Ll1/x2;
    ...
    invoke-virtual {v6, v2, v5, v2, v2}, Ll1/x2;->x(IIII)Ll1/x2;

    move-result-object v2

    :goto_2
    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->D:Ll1/x2;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->D:Ll1/x2;

    invoke-virtual {v4}, Ll1/x2;->r()I

    move-result v4

    add-int/2addr v4, v5

    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->D:Ll1/x2;

    invoke-virtual {v5}, Ll1/x2;->q()I

    move-result v5

    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->D:Ll1/x2;

    invoke-virtual {v6}, Ll1/x2;->o()I

    move-result v6

    invoke-static {v2, v4, v5, v6}, Lt0/f0;->d(IIII)Lt0/f0;

    move-result-object v2

    new-instance v4, Ll1/x2$b;

    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->D:Ll1/x2;

    invoke-direct {v4, v5}, Ll1/x2$b;-><init>(Ll1/x2;)V

    invoke-virtual {v4, v2}, Ll1/x2$b;->h(Lt0/f0;)Ll1/x2$b;

    move-result-object v2

    invoke-virtual {v2}, Ll1/x2$b;->a()Ll1/x2;
    ...
    invoke-virtual/range {v4 .. v10}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->E:Ll1/x2;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->D:Ll1/x2;

    invoke-virtual {v2, v4}, Ll1/x2;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_5

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->D:Ll1/x2;

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->E:Ll1/x2;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->j:Landroidx/appcompat/widget/ContentFrameLayout;

    invoke-static {v4, v2}, Ll1/j1;->p(Landroid/view/View;Ll1/x2;)Ll1/x2;
...
.method public onNestedFling(Landroid/view/View;FFZ)Z
    ...
    :cond_0
    invoke-virtual {p0, p3}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->G(F)Z
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Ll1/y0;->b(Landroid/view/View;Landroid/view/View;I)V
...
.method public q(Landroid/util/SparseArray;)V
    ...
    invoke-interface {v0, p1}, Lo/i0;->w(Landroid/util/SparseArray;)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Lo/i0;->setWindowCallback(Landroid/view/Window$Callback;)V
...
.method public final u(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
    .locals 2
...
.method public v()Landroidx/appcompat/widget/ActionBarOverlayLayout$e;
    .locals 2
...
.method public w(Landroid/util/AttributeSet;)Landroidx/appcompat/widget/ActionBarOverlayLayout$e;
    .locals 2
...
.method public final x(Landroid/view/View;)Lo/i0;
    .locals 3
