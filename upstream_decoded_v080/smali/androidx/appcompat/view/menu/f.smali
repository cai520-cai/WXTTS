...
.method public a()V
    ...
    invoke-virtual {v0}, Lh/s;->dismiss()V
...
.method public b(Landroidx/appcompat/view/menu/e;Z)V
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/view/menu/f;->k:Landroidx/appcompat/view/menu/j$a;
...
.method public d(Landroidx/appcompat/view/menu/j$a;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/appcompat/view/menu/f;->k:Landroidx/appcompat/view/menu/j$a;
...
.method public e(Landroid/os/IBinder;)V
    ...
    iput-object v2, p0, Landroidx/appcompat/view/menu/f;->j:Landroidx/appcompat/view/menu/c;

    invoke-virtual {v2, p0}, Landroidx/appcompat/view/menu/c;->n(Landroidx/appcompat/view/menu/j$a;)V

    iget-object v2, p0, Landroidx/appcompat/view/menu/f;->a:Landroidx/appcompat/view/menu/e;

    iget-object v3, p0, Landroidx/appcompat/view/menu/f;->j:Landroidx/appcompat/view/menu/c;

    invoke-virtual {v2, v3}, Landroidx/appcompat/view/menu/e;->b(Landroidx/appcompat/view/menu/j;)V

    iget-object v2, p0, Landroidx/appcompat/view/menu/f;->j:Landroidx/appcompat/view/menu/c;
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/e;->B()Landroid/view/View;

    move-result-object v2

    if-eqz v2, :cond_0

    invoke-virtual {v1, v2}, Landroidx/appcompat/app/a$a;->f(Landroid/view/View;)Landroidx/appcompat/app/a$a;

    goto :goto_0

    :cond_0
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/e;->z()Landroid/graphics/drawable/Drawable;

    move-result-object v2

    invoke-virtual {v1, v2}, Landroidx/appcompat/app/a$a;->h(Landroid/graphics/drawable/Drawable;)Landroidx/appcompat/app/a$a;

    move-result-object v2

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/e;->A()Ljava/lang/CharSequence;

    move-result-object v0

    invoke-virtual {v2, v0}, Landroidx/appcompat/app/a$a;->K(Ljava/lang/CharSequence;)Landroidx/appcompat/app/a$a;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/f;->j:Landroidx/appcompat/view/menu/c;
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/f;->j:Landroidx/appcompat/view/menu/c;
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p2, v1}, Landroidx/appcompat/view/menu/e;->f(Z)V
