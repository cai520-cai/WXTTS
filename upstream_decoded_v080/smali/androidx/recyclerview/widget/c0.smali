...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroidx/recyclerview/widget/c0$c;
    }
.end annotation
...
.method public a(IIII)Landroid/view/View;
    ...
    invoke-interface {v0}, Landroidx/recyclerview/widget/c0$b;->d()I
    ...
    invoke-interface {v4, p1}, Landroidx/recyclerview/widget/c0$b;->a(I)Landroid/view/View;

    move-result-object v4

    iget-object v5, p0, Landroidx/recyclerview/widget/c0;->a:Landroidx/recyclerview/widget/c0$b;

    invoke-interface {v5, v4}, Landroidx/recyclerview/widget/c0$b;->c(Landroid/view/View;)I

    move-result v5

    iget-object v6, p0, Landroidx/recyclerview/widget/c0;->a:Landroidx/recyclerview/widget/c0$b;

    invoke-interface {v6, v4}, Landroidx/recyclerview/widget/c0$b;->e(Landroid/view/View;)I

    move-result v6

    iget-object v7, p0, Landroidx/recyclerview/widget/c0;->b:Landroidx/recyclerview/widget/c0$a;

    invoke-virtual {v7, v0, v1, v5, v6}, Landroidx/recyclerview/widget/c0$a;->e(IIII)V

    if-eqz p3, :cond_1

    iget-object v5, p0, Landroidx/recyclerview/widget/c0;->b:Landroidx/recyclerview/widget/c0$a;

    invoke-virtual {v5}, Landroidx/recyclerview/widget/c0$a;->d()V

    iget-object v5, p0, Landroidx/recyclerview/widget/c0;->b:Landroidx/recyclerview/widget/c0$a;

    invoke-virtual {v5, p3}, Landroidx/recyclerview/widget/c0$a;->a(I)V

    iget-object v5, p0, Landroidx/recyclerview/widget/c0;->b:Landroidx/recyclerview/widget/c0$a;

    invoke-virtual {v5}, Landroidx/recyclerview/widget/c0$a;->b()Z
    ...
    invoke-virtual {v5, p4}, Landroidx/recyclerview/widget/c0$a;->a(I)V
...
.method public b(Landroid/view/View;I)Z
    ...
    invoke-interface {v1}, Landroidx/recyclerview/widget/c0$b;->d()I

    move-result v1

    iget-object v2, p0, Landroidx/recyclerview/widget/c0;->a:Landroidx/recyclerview/widget/c0$b;

    invoke-interface {v2}, Landroidx/recyclerview/widget/c0$b;->b()I

    move-result v2

    iget-object v3, p0, Landroidx/recyclerview/widget/c0;->a:Landroidx/recyclerview/widget/c0$b;

    invoke-interface {v3, p1}, Landroidx/recyclerview/widget/c0$b;->c(Landroid/view/View;)I

    move-result v3

    iget-object v4, p0, Landroidx/recyclerview/widget/c0;->a:Landroidx/recyclerview/widget/c0$b;

    invoke-interface {v4, p1}, Landroidx/recyclerview/widget/c0$b;->e(Landroid/view/View;)I

    move-result p1

    invoke-virtual {v0, v1, v2, v3, p1}, Landroidx/recyclerview/widget/c0$a;->e(IIII)V

    if-eqz p2, :cond_0

    iget-object p1, p0, Landroidx/recyclerview/widget/c0;->b:Landroidx/recyclerview/widget/c0$a;

    invoke-virtual {p1}, Landroidx/recyclerview/widget/c0$a;->d()V

    iget-object p1, p0, Landroidx/recyclerview/widget/c0;->b:Landroidx/recyclerview/widget/c0$a;

    invoke-virtual {p1, p2}, Landroidx/recyclerview/widget/c0$a;->a(I)V

    iget-object p1, p0, Landroidx/recyclerview/widget/c0;->b:Landroidx/recyclerview/widget/c0$a;

    invoke-virtual {p1}, Landroidx/recyclerview/widget/c0$a;->b()Z
