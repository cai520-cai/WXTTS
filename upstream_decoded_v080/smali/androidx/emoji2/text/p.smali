...
.method public static a(Landroidx/emoji2/text/p$d;)Landroidx/emoji2/text/p$c;
    .locals 12
    ...
    invoke-interface {p0, v0}, Landroidx/emoji2/text/p$d;->a(I)V
    ...
    invoke-interface {p0, v2}, Landroidx/emoji2/text/p$d;->a(I)V
    ...
    invoke-interface {p0}, Landroidx/emoji2/text/p$d;->c()I

    move-result v7

    invoke-interface {p0, v0}, Landroidx/emoji2/text/p$d;->a(I)V

    invoke-interface {p0}, Landroidx/emoji2/text/p$d;->b()J
    ...
    invoke-interface {p0}, Landroidx/emoji2/text/p$d;->d()J
...
.method public static b(Landroid/content/res/AssetManager;Ljava/lang/String;)Ld2/p;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :try_start_0
    invoke-static {p0}, Landroidx/emoji2/text/p;->c(Ljava/io/InputStream;)Ld2/p;
...
.method public static c(Ljava/io/InputStream;)Ld2/p;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {v0}, Landroidx/emoji2/text/p$d;->d()J
    ...
    invoke-interface {v0, v2}, Landroidx/emoji2/text/p$d;->a(I)V
    ...
    invoke-static {v0}, Ld2/p;->G(Ljava/nio/ByteBuffer;)Ld2/p;
...
.method public static d(Ljava/nio/ByteBuffer;)Ld2/p;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {p0}, Ld2/p;->G(Ljava/nio/ByteBuffer;)Ld2/p;
