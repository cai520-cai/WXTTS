...
.method public static synthetic A(Ljava/util/Set;Ljava/util/List;Landroid/content/DialogInterface;I)V
    ...
    :goto_0
    invoke-static {p0}, Ls5/z2;->N(Ljava/lang/String;)V
    ...
    sget-object v1, Ls5/z2;->e:Ljava/lang/ClassLoader;

    sget-object v2, Ls5/z2;->d:Ljava/lang/String;
...
.method public static C()Ljava/lang/String;
    ...
    .line 1
    sget-object v0, Ls5/z2;->e:Ljava/lang/ClassLoader;

    sget-object v1, Ls5/z2;->d:Ljava/lang/String;
...
.method public static E()V
    ...
    sget-object v1, Ls5/z2;->f:Landroid/app/Activity;
...
.method public static F()V
    ...
    invoke-direct {v2}, Ls5/s2;-><init>()V
    ...
    sget-object v2, Ls5/z2;->f:Landroid/app/Activity;
    ...
    invoke-direct {v2, v1}, Ls5/t2;-><init>(Landroid/widget/EditText;)V
...
.method public static G(Landroid/app/Activity;Ljava/util/List;)V
    ...
    invoke-direct {v1, v0, p1}, Ls5/g2;-><init>(Landroid/widget/EditText;Ljava/util/List;)V
...
.method public static H(Landroid/app/Activity;Ljava/lang/ClassLoader;Ljava/lang/String;)V
    ...
    .line 1
    sput-object p0, Ls5/z2;->f:Landroid/app/Activity;

    sput-object p1, Ls5/z2;->e:Ljava/lang/ClassLoader;

    sput-object p2, Ls5/z2;->d:Ljava/lang/String;
    ...
    sput-object p0, Ls5/z2;->c:Landroid/view/WindowManager;
    ...
    :cond_0
    sget-boolean p0, Ls5/z2;->g:Z

    if-eqz p0, :cond_1

    invoke-static {}, Ls5/z2;->t()V

    return-void

    :cond_1
    invoke-static {}, Ls5/z2;->M()V
...
.method public static I()V
    ...
    .line 1
    :try_start_0
    sget-object v0, Ls5/z2;->f:Landroid/app/Activity;

    new-instance v1, Ls5/p2;

    invoke-direct {v1}, Ls5/p2;-><init>()V
    ...
    new-instance v2, Ls5/q2;

    invoke-direct {v2, v0}, Ls5/q2;-><init>(Landroid/widget/EditText;)V
...
.method public static J()V
    ...
    sget-object v3, Ls5/z2;->f:Landroid/app/Activity;
    ...
    new-instance v3, Ls5/z2$a;

    invoke-direct {v3, v0, v1}, Ls5/z2$a;-><init>(Ljava/util/List;Ljava/util/Set;)V

    invoke-virtual {v2, v3}, Landroid/widget/ListView;->setAdapter(Landroid/widget/ListAdapter;)V

    new-instance v3, Landroid/app/AlertDialog$Builder;

    sget-object v4, Ls5/z2;->f:Landroid/app/Activity;
    ...
    new-instance v4, Ls5/r2;

    invoke-direct {v4, v1, v0}, Ls5/r2;-><init>(Ljava/util/Set;Ljava/util/List;)V
    ...
    invoke-static {v0}, Ls5/z2;->N(Ljava/lang/String;)V
    :try_end_0
...
.method public static K()V
    ...
    new-instance v3, Ls5/z2$b;

    invoke-direct {v3, v0}, Ls5/z2$b;-><init>(Ljava/util/List;)V
...
.method public static L()V
    ...
    sget-object v2, Ls5/z2;->e:Ljava/lang/ClassLoader;

    sget-object v3, Ls5/z2;->d:Ljava/lang/String;
...
.method public static M()V
    ...
    sget-object v5, Ls5/z2;->f:Landroid/app/Activity;
    ...
    invoke-static {v2}, Ls5/z2;->k(Landroid/widget/LinearLayout;)V
    ...
    new-instance v2, Ls5/u2;

    invoke-direct {v2}, Ls5/u2;-><init>()V
    ...
    new-instance v0, Ls5/v2;

    invoke-direct {v0}, Ls5/v2;-><init>()V

    invoke-virtual {v1, v0}, Landroid/app/Dialog;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V

    invoke-virtual {v1}, Landroid/app/Dialog;->show()V

    invoke-static {v1}, Ls5/z2;->l(Landroid/app/Dialog;)V

    sput-object v1, Ls5/z2;->b:Landroid/app/Dialog;

    sput-boolean v3, Ls5/z2;->g:Z
...
.method public static synthetic a(Landroid/content/DialogInterface;I)V
    ...
    .line 1
    invoke-static {p0, p1}, Ls5/z2;->u(Landroid/content/DialogInterface;I)V
...
.method public static synthetic b(Landroid/content/DialogInterface;)V
    ...
    .line 1
    invoke-static {p0}, Ls5/z2;->B(Landroid/content/DialogInterface;)V
...
.method public static synthetic c(Landroid/widget/EditText;Landroid/content/DialogInterface;I)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Ls5/z2;->w(Landroid/widget/EditText;Landroid/content/DialogInterface;I)V
...
.method public static synthetic d(Ljava/util/List;)V
    ...
    .line 1
    invoke-static {p0}, Ls5/z2;->y(Ljava/util/List;)V
...
.method public static synthetic e(Landroid/widget/EditText;Ljava/util/List;Landroid/content/DialogInterface;I)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3}, Ls5/z2;->x(Landroid/widget/EditText;Ljava/util/List;Landroid/content/DialogInterface;I)V
...
.method public static synthetic f(Ljava/util/Set;Ljava/util/List;Landroid/content/DialogInterface;I)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3}, Ls5/z2;->A(Ljava/util/Set;Ljava/util/List;Landroid/content/DialogInterface;I)V
...
.method public static synthetic g(Ljava/util/List;)V
    ...
    .line 1
    invoke-static {p0}, Ls5/z2;->v(Ljava/util/List;)V
...
.method public static synthetic h(Landroid/widget/EditText;Landroid/content/DialogInterface;I)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Ls5/z2;->z(Landroid/widget/EditText;Landroid/content/DialogInterface;I)V
...
.method public static k(Landroid/widget/LinearLayout;)V
    ...
    new-instance v1, Ls5/x2;

    invoke-direct {v1}, Ls5/x2;-><init>()V
...
.method public static l(Landroid/app/Dialog;)V
    ...
    invoke-static {v0}, Ls5/z2;->p(I)I

    move-result v0

    const/16 v1, 0x230

    invoke-static {v1}, Ls5/z2;->p(I)I
    ...
    sget-object v3, Ls5/z2;->a:Lt5/h$a;
    ...
    sget-object v6, Ls5/z2;->a:Lt5/h$a;
    ...
    sget-object v6, Ls5/z2;->f:Landroid/app/Activity;
...
.method public static o()V
    ...
    sget-object v0, Ls5/z2;->a:Lt5/h$a;
    ...
    sput-object v1, Ls5/z2;->a:Lt5/h$a;

    :cond_0
    sput-object v1, Ls5/z2;->f:Landroid/app/Activity;
...
.method public static q()V
    ...
    :try_start_1
    sget-object v6, Ls5/z2;->e:Ljava/lang/ClassLoader;

    invoke-static {v6, v5}, Lt5/d;->u(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    invoke-static {v6}, Ls5/z2;->n(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5}, Ls5/z2;->n(Ljava/lang/String;)Ljava/lang/String;
...
.method public static r()V
    ...
    sget-object v5, Ls5/z2;->e:Ljava/lang/ClassLoader;
    ...
    :cond_3
    invoke-static {v4}, Ls5/z2;->n(Ljava/lang/String;)Ljava/lang/String;
...
.method public static s()V
    ...
    sget-object v3, Ls5/z2;->e:Ljava/lang/ClassLoader;

    sget-object v4, Ls5/z2;->d:Ljava/lang/String;

    invoke-static {v3, v4}, Lt5/d;->u(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-static {v3, v0}, Ls5/z2;->D(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static t()V
    ...
    .line 1
    sget-object v0, Ls5/z2;->b:Landroid/app/Dialog;
    ...
    sput-object v0, Ls5/z2;->b:Landroid/app/Dialog;

    :cond_0
    const/4 v0, 0x0

    sput-boolean v0, Ls5/z2;->g:Z
...
.method public static synthetic u(Landroid/content/DialogInterface;I)V
    ...
    sget-object v0, Ls5/z2;->d:Ljava/lang/String;

    invoke-virtual {p0, p1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    sget-object p1, Ls5/z2;->f:Landroid/app/Activity;
...
.method public static synthetic v(Ljava/util/List;)V
    ...
    invoke-static {v0, p0}, Ls5/z2;->G(Landroid/app/Activity;Ljava/util/List;)V
...
.method public static synthetic w(Landroid/widget/EditText;Landroid/content/DialogInterface;I)V
    ...
    :cond_0
    sget-object p1, Ls5/z2;->e:Ljava/lang/ClassLoader;

    invoke-static {p1}, Lt5/d;->g(Ljava/lang/ClassLoader;)Ljava/util/List;

    move-result-object p1

    sget-object p2, Ls5/z2;->e:Ljava/lang/ClassLoader;
...
.method public static synthetic x(Landroid/widget/EditText;Ljava/util/List;Landroid/content/DialogInterface;I)V
    ...
    check-cast p3, Lcom/leshao/v3/model/ContactCard;

    iget-object p3, p3, Lcom/leshao/v3/model/ContactCard;->username:Ljava/lang/String;
...
.method public static synthetic y(Ljava/util/List;)V
    ...
    :cond_1
    sget-object p0, Ls5/z2;->e:Ljava/lang/ClassLoader;
...
.method public static synthetic z(Landroid/widget/EditText;Landroid/content/DialogInterface;I)V
    ...
    sget-object p2, Ls5/z2;->d:Ljava/lang/String;
