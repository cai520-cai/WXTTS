...
.method public static c(Landroid/content/pm/PackageInfo;)J
    ...
    invoke-static {p0}, Lp0/c$a;->b(Landroid/content/pm/PackageInfo;)J
...
.method public static d(Landroid/content/pm/PackageManager;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0}, Lp0/b;->a(Landroid/content/pm/PackageInfo;)Landroid/content/pm/SigningInfo;

    move-result-object p0

    invoke-static {p0}, Lp0/c$a;->d(Landroid/content/pm/SigningInfo;)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-static {p0}, Lp0/c$a;->a(Landroid/content/pm/SigningInfo;)[Landroid/content/pm/Signature;
    ...
    :cond_0
    invoke-static {p0}, Lp0/c$a;->c(Landroid/content/pm/SigningInfo;)[Landroid/content/pm/Signature;
...
.method public static e(Landroid/content/pm/PackageManager;Ljava/lang/String;Ljava/util/Map;Z)Z
    ...
    :cond_5
    invoke-static {p0, p1}, Lp0/c;->d(Landroid/content/pm/PackageManager;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0, p1, v0, v2}, Lp0/c$a;->e(Landroid/content/pm/PackageManager;Ljava/lang/String;[BI)Z
    ...
    invoke-static {p0, p1}, Lp0/c;->a([[B[B)Z
