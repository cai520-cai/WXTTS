...
.field public static final h:Ljava/lang/String; = "AppCompatViewInflater"

.field public static final i:Lv/i;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lv/i<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lh/u;->b:[Ljava/lang/Class;
    ...
    sput-object v0, Lh/u;->g:[Ljava/lang/String;

    new-instance v0, Lv/i;

    invoke-direct {v0}, Lv/i;-><init>()V

    sput-object v0, Lh/u;->i:Lv/i;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lh/u;->a:[Ljava/lang/Object;
...
.method public final a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p2, v2}, Ll1/j1;->C1(Landroid/view/View;Z)V

    :cond_1
    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    sget-object v0, Lh/u;->e:[I
    ...
    invoke-static {p2, v2}, Ll1/j1;->E1(Landroid/view/View;Ljava/lang/CharSequence;)V

    :cond_2
    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    sget-object v0, Lh/u;->f:[I
    ...
    invoke-static {p2, p3}, Ll1/j1;->n2(Landroid/view/View;Z)V
...
.method public final b(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1}, Ll1/j1;->K0(Landroid/view/View;)Z
    ...
    new-instance v1, Lh/u$a;

    invoke-direct {v1, p1, v0}, Lh/u$a;-><init>(Landroid/view/View;Ljava/lang/String;)V
...
.method public o(Landroid/content/Context;Landroid/util/AttributeSet;)Lo/c0;
    ...
    invoke-direct {v0, p1, p2}, Lo/c0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-object v0
.end method

.method public p(Landroid/content/Context;Landroid/util/AttributeSet;)Lo/g0;
    .locals 1
    .annotation build Le/m0;
    .end annotation
    ...
    invoke-direct {v0, p1, p2}, Lo/g0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final r(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    :cond_1
    invoke-static {p1, p4, p6, p7}, Lh/u;->u(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    invoke-virtual {p0, p1, p2, p4}, Lh/u;->q(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :pswitch_0
    invoke-virtual {p0, p1, p4}, Lh/u;->d(Landroid/content/Context;Landroid/util/AttributeSet;)Lo/e;

    move-result-object p5

    :goto_2
    invoke-virtual {p0, p5, p2}, Lh/u;->v(Landroid/view/View;Ljava/lang/String;)V

    goto :goto_3

    :pswitch_1
    invoke-virtual {p0, p1, p4}, Lh/u;->g(Landroid/content/Context;Landroid/util/AttributeSet;)Lo/k;
    ...
    :pswitch_2
    invoke-virtual {p0, p1, p4}, Lh/u;->e(Landroid/content/Context;Landroid/util/AttributeSet;)Lo/f;
    ...
    :pswitch_3
    invoke-virtual {p0, p1, p4}, Lh/u;->c(Landroid/content/Context;Landroid/util/AttributeSet;)Lo/c;
    ...
    :pswitch_4
    invoke-virtual {p0, p1, p4}, Lh/u;->i(Landroid/content/Context;Landroid/util/AttributeSet;)Lo/q;
    ...
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Lh/u;->p(Landroid/content/Context;Landroid/util/AttributeSet;)Lo/g0;
    ...
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Lh/u;->k(Landroid/content/Context;Landroid/util/AttributeSet;)Lo/u;
    ...
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Lh/u;->n(Landroid/content/Context;Landroid/util/AttributeSet;)Lo/z;
    ...
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Lh/u;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Lo/x;
    ...
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Lh/u;->h(Landroid/content/Context;Landroid/util/AttributeSet;)Lo/o;
    ...
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Lh/u;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Lo/c0;
    ...
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Lh/u;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Lo/r;
    ...
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Lh/u;->f(Landroid/content/Context;Landroid/util/AttributeSet;)Lo/g;
    ...
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Lh/u;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Lo/v;
    ...
    invoke-virtual {p0, p1, p2, p4}, Lh/u;->t(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-virtual {p0, p5, p4}, Lh/u;->b(Landroid/view/View;Landroid/util/AttributeSet;)V

    invoke-virtual {p0, p1, p5, p4}, Lh/u;->a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
...
.method public final s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    sget-object p3, Lh/u;->b:[Ljava/lang/Class;

    invoke-virtual {p1, p3}, Ljava/lang/Class;->getConstructor([Ljava/lang/Class;)Ljava/lang/reflect/Constructor;

    move-result-object v1

    invoke-virtual {v0, p2, v1}, Lv/i;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p1, p0, Lh/u;->a:[Ljava/lang/Object;
...
.method public final t(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :try_start_0
    iget-object v3, p0, Lh/u;->a:[Ljava/lang/Object;
    ...
    :goto_0
    sget-object v3, Lh/u;->g:[Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, p2, v3}, Lh/u;->s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    :cond_3
    :try_start_1
    invoke-virtual {p0, p1, p2, v1}, Lh/u;->s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    iget-object p2, p0, Lh/u;->a:[Ljava/lang/Object;
