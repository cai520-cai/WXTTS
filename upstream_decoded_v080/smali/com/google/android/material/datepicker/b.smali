...
# direct methods
.method public constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILx4/p;Landroid/graphics/Rect;)V
    .locals 1
    ...
    iput-object p5, p0, Lcom/google/android/material/datepicker/b;->f:Lx4/p;
...
.method public static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/b;
    ...
    invoke-static {v1, v2}, Lk1/v;->b(ZLjava/lang/Object;)V

    sget-object v1, Lm3/a$o;->kl:[I

    invoke-virtual {p0, p1, v1}, Landroid/content/Context;->obtainStyledAttributes(I[I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget v1, Lm3/a$o;->ll:I

    invoke-virtual {p1, v1, v0}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v1

    sget v2, Lm3/a$o;->nl:I

    invoke-virtual {p1, v2, v0}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v2

    sget v3, Lm3/a$o;->ml:I

    invoke-virtual {p1, v3, v0}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v3

    sget v4, Lm3/a$o;->ol:I
    ...
    sget v1, Lm3/a$o;->pl:I

    invoke-static {p0, p1, v1}, Lt4/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v6

    sget v1, Lm3/a$o;->ul:I

    invoke-static {p0, p1, v1}, Lt4/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v7

    sget v1, Lm3/a$o;->sl:I

    invoke-static {p0, p1, v1}, Lt4/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v8

    sget v1, Lm3/a$o;->tl:I

    invoke-virtual {p1, v1, v0}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v9

    sget v1, Lm3/a$o;->ql:I

    invoke-virtual {p1, v1, v0}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v1

    sget v2, Lm3/a$o;->rl:I

    invoke-virtual {p1, v2, v0}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v0

    invoke-static {p0, v1, v0}, Lx4/p;->b(Landroid/content/Context;II)Lx4/p$b;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILx4/p;Landroid/graphics/Rect;)V
...
.method public f(Landroid/widget/TextView;)V
    ...
    invoke-virtual {p0, p1, v0, v0}, Lcom/google/android/material/datepicker/b;->g(Landroid/widget/TextView;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;)V

    return-void
.end method

.method public g(Landroid/widget/TextView;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;)V
    .locals 8
    .param p1    # Landroid/widget/TextView;
        .annotation build Le/m0;
        .end annotation
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lx4/p;

    invoke-virtual {v0, v2}, Lx4/k;->setShapeAppearanceModel(Lx4/p;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lx4/p;

    invoke-virtual {v1, v2}, Lx4/k;->setShapeAppearanceModel(Lx4/p;)V
    ...
    invoke-virtual {v0, p2, v2}, Lx4/k;->F0(FLandroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1, p2}, Ll1/j1;->I1(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
