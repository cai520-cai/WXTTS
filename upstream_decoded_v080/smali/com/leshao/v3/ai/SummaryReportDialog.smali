...
.method public static synthetic a(Landroid/app/Dialog;Landroid/view/View;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/leshao/v3/ai/SummaryReportDialog;->lambda$show$0(Landroid/app/Dialog;Landroid/view/View;)V
...
.method public static show(Landroid/app/Activity;Ljava/lang/String;Lcom/leshao/v3/ai/SummaryFeature$SummaryStats;)V
    ...
    iget v3, p2, Lcom/leshao/v3/ai/SummaryFeature$SummaryStats;->total:I
    ...
    invoke-static {p0, v7, v3}, Lcom/leshao/v3/ai/SummaryReportDialog;->card(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    iget v7, p2, Lcom/leshao/v3/ai/SummaryFeature$SummaryStats;->meCount:I
    ...
    iget v8, p2, Lcom/leshao/v3/ai/SummaryFeature$SummaryStats;->otherCount:I
    ...
    invoke-static {p0, v8, v3}, Lcom/leshao/v3/ai/SummaryReportDialog;->card(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    iget v8, p2, Lcom/leshao/v3/ai/SummaryFeature$SummaryStats;->meChars:I
    ...
    iget v8, p2, Lcom/leshao/v3/ai/SummaryFeature$SummaryStats;->otherChars:I

    invoke-virtual {v3, v8}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    invoke-virtual {v3, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v7, p2, Lcom/leshao/v3/ai/SummaryFeature$SummaryStats;->maxLen:I
    ...
    invoke-static {p0, v3, v7}, Lcom/leshao/v3/ai/SummaryReportDialog;->card(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    invoke-static {p0, v3}, Lcom/leshao/v3/ai/SummaryReportDialog;->sectionTitle(Landroid/app/Activity;Ljava/lang/String;)Landroid/widget/TextView;

    move-result-object v3

    invoke-virtual {v2, v3}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    new-instance v3, Lcom/leshao/v3/ai/SummaryReportDialog$TypeBarView;

    invoke-direct {v3, p0, p2}, Lcom/leshao/v3/ai/SummaryReportDialog$TypeBarView;-><init>(Landroid/app/Activity;Lcom/leshao/v3/ai/SummaryFeature$SummaryStats;)V

    invoke-virtual {v2, v3}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    iget-object v3, p2, Lcom/leshao/v3/ai/SummaryFeature$SummaryStats;->topKeywords:Ljava/util/List;
    ...
    invoke-static {p0, v3}, Lcom/leshao/v3/ai/SummaryReportDialog;->keywordCloud(Landroid/app/Activity;Ljava/util/List;)Landroid/view/View;
    ...
    new-instance v3, Lcom/leshao/v3/ai/SummaryReportDialog$BarChartView;

    iget-object v7, p2, Lcom/leshao/v3/ai/SummaryFeature$SummaryStats;->hourDist:[I

    invoke-direct {v3, p0, v7}, Lcom/leshao/v3/ai/SummaryReportDialog$BarChartView;-><init>(Landroid/app/Activity;[I)V
    ...
    new-instance v3, Lcom/leshao/v3/ai/SummaryReportDialog$PieChartView;

    iget v7, p2, Lcom/leshao/v3/ai/SummaryFeature$SummaryStats;->meCount:I

    iget p2, p2, Lcom/leshao/v3/ai/SummaryFeature$SummaryStats;->otherCount:I

    invoke-direct {v3, p0, v7, p2}, Lcom/leshao/v3/ai/SummaryReportDialog$PieChartView;-><init>(Landroid/app/Activity;II)V

    invoke-virtual {v2, v3}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    const-string p2, "\ud83d\udcdd AI \u6df1\u5ea6\u5206\u6790\u62a5\u544a"

    invoke-static {p0, p2}, Lcom/leshao/v3/ai/SummaryReportDialog;->sectionTitle(Landroid/app/Activity;Ljava/lang/String;)Landroid/widget/TextView;
    ...
    new-instance p0, Lcom/leshao/v3/ai/a2;

    invoke-direct {p0, v0}, Lcom/leshao/v3/ai/a2;-><init>(Landroid/app/Dialog;)V
