...
.method public static synthetic a(Lcom/leshao/v3/ai/AiClient$Callback;Ljava/lang/String;Ljava/util/List;)V
    .locals 0

    .line 1
    invoke-static {p0, p1, p2}, Lcom/leshao/v3/ai/AiClient;->lambda$chatAsync$0(Lcom/leshao/v3/ai/AiClient$Callback;Ljava/lang/String;Ljava/util/List;)V
...
.method public static synthetic b(Ljava/lang/String;Ljava/lang/String;Lcom/leshao/v3/ai/AiClient$ModelsCallback;)V
    .locals 0

    .line 1
    invoke-static {p0, p1, p2}, Lcom/leshao/v3/ai/AiClient;->lambda$listModelsAsync$2(Ljava/lang/String;Ljava/lang/String;Lcom/leshao/v3/ai/AiClient$ModelsCallback;)V
...
.method private static buildBody(Ljava/lang/String;Ljava/util/List;Z)Lorg/json/JSONObject;
    ...
    check-cast p1, Lcom/leshao/v3/ai/AiClient$ChatMessage;

    new-instance v3, Lorg/json/JSONObject;

    invoke-direct {v3}, Lorg/json/JSONObject;-><init>()V

    iget-object v4, p1, Lcom/leshao/v3/ai/AiClient$ChatMessage;->role:Ljava/lang/String;

    invoke-virtual {v3, v2, v4}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    move-result-object v3

    iget-object p1, p1, Lcom/leshao/v3/ai/AiClient$ChatMessage;->content:Ljava/lang/String;
...
.method public static synthetic c(Ljava/lang/String;Ljava/util/List;Lcom/leshao/v3/ai/AiClient$StreamCallback;)V
    .locals 0

    .line 1
    invoke-static {p0, p1, p2}, Lcom/leshao/v3/ai/AiClient;->lambda$chatStream$1(Ljava/lang/String;Ljava/util/List;Lcom/leshao/v3/ai/AiClient$StreamCallback;)V
...
.method public static chatAsync(Ljava/lang/String;Ljava/util/List;Lcom/leshao/v3/ai/AiClient$Callback;)V
    ...
    new-instance v1, Lcom/leshao/v3/ai/k;

    invoke-direct {v1, p2, p0, p1}, Lcom/leshao/v3/ai/k;-><init>(Lcom/leshao/v3/ai/AiClient$Callback;Ljava/lang/String;Ljava/util/List;)V
...
.method public static chatStream(Ljava/lang/String;Ljava/util/List;Lcom/leshao/v3/ai/AiClient$StreamCallback;)V
    ...
    new-instance v1, Lcom/leshao/v3/ai/l;

    invoke-direct {v1, p0, p1, p2}, Lcom/leshao/v3/ai/l;-><init>(Ljava/lang/String;Ljava/util/List;Lcom/leshao/v3/ai/AiClient$StreamCallback;)V
...
.method public static chatSync(Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-static {p1, p0}, Lcom/leshao/v3/ai/AiClient;->responseStream(Ljava/net/HttpURLConnection;I)Ljava/io/InputStream;
...
.method private static synthetic lambda$chatAsync$0(Lcom/leshao/v3/ai/AiClient$Callback;Ljava/lang/String;Ljava/util/List;)V
    .locals 0
    ...
    invoke-interface {p0, p1}, Lcom/leshao/v3/ai/AiClient$Callback;->onResult(Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-static {p1}, Lcom/leshao/v3/ai/AiClient;->diagError(Ljava/lang/Exception;)Ljava/lang/String;

    move-result-object p1

    invoke-interface {p0, p1}, Lcom/leshao/v3/ai/AiClient$Callback;->onError(Ljava/lang/String;)V

    :goto_0
    return-void
.end method

.method private static synthetic lambda$chatStream$1(Ljava/lang/String;Ljava/util/List;Lcom/leshao/v3/ai/AiClient$StreamCallback;)V
    .locals 5
    ...
    invoke-interface {p2, v1}, Lcom/leshao/v3/ai/AiClient$StreamCallback;->onDelta(Ljava/lang/String;)V
    :try_end_9
    ...
    invoke-interface {p2, p0}, Lcom/leshao/v3/ai/AiClient$StreamCallback;->onDone(Ljava/lang/String;)V
    :try_end_a
    ...
    :goto_8
    :try_start_f
    invoke-static {p0}, Lcom/leshao/v3/ai/AiClient;->diagError(Ljava/lang/Exception;)Ljava/lang/String;

    move-result-object p0

    invoke-interface {p2, p0}, Lcom/leshao/v3/ai/AiClient$StreamCallback;->onError(Ljava/lang/String;)V
    :try_end_f
...
.method private static synthetic lambda$listModelsAsync$2(Ljava/lang/String;Ljava/lang/String;Lcom/leshao/v3/ai/AiClient$ModelsCallback;)V
    .locals 5
    ...
    invoke-static {p0, p1}, Lcom/leshao/v3/ai/AiClient;->responseStream(Ljava/net/HttpURLConnection;I)Ljava/io/InputStream;
    ...
    :cond_2
    invoke-interface {p2, p1}, Lcom/leshao/v3/ai/AiClient$ModelsCallback;->onModels(Ljava/util/List;)V
    ...
    invoke-interface {p2, p0}, Lcom/leshao/v3/ai/AiClient$ModelsCallback;->onError(Ljava/lang/String;)V
...
.method public static listModelsAsync(Ljava/lang/String;Ljava/lang/String;Lcom/leshao/v3/ai/AiClient$ModelsCallback;)V
    ...
    new-instance v1, Lcom/leshao/v3/ai/j;

    invoke-direct {v1, p0, p1, p2}, Lcom/leshao/v3/ai/j;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/leshao/v3/ai/AiClient$ModelsCallback;)V
