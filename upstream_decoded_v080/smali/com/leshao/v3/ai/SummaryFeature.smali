...
.method public static synthetic a(Ljava/util/List;Landroid/app/Activity;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/leshao/v3/ai/SummaryFeature;->lambda$doSummary$1(Ljava/util/List;Landroid/app/Activity;)V
...
.method public static synthetic b(Landroid/app/Activity;Ljava/lang/ClassLoader;Landroid/view/View;)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lcom/leshao/v3/ai/SummaryFeature;->lambda$injectSummaryButton$0(Landroid/app/Activity;Ljava/lang/ClassLoader;Landroid/view/View;)V
...
.method public static synthetic c(Ljava/lang/ClassLoader;Ljava/lang/String;Landroid/app/Activity;)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lcom/leshao/v3/ai/SummaryFeature;->lambda$doSummary$2(Ljava/lang/ClassLoader;Ljava/lang/String;Landroid/app/Activity;)V
...
.method public static synthetic d(Ljava/util/Map$Entry;Ljava/util/Map$Entry;)I
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/leshao/v3/ai/SummaryFeature;->lambda$extractTopKeywords$3(Ljava/util/Map$Entry;Ljava/util/Map$Entry;)I
...
.method public static doSummary(Landroid/app/Activity;Ljava/lang/ClassLoader;)V
    ...
    new-instance v2, Lcom/leshao/v3/ai/s1;

    invoke-direct {v2, p1, v0, p0}, Lcom/leshao/v3/ai/s1;-><init>(Ljava/lang/ClassLoader;Ljava/lang/String;Landroid/app/Activity;)V
...
.method private static extractTopKeywords(Ljava/util/List;I)Ljava/util/List;
    ...
    check-cast v1, Lcom/leshao/v3/ai/MessageReader$ChatMsg;

    invoke-virtual {v1}, Lcom/leshao/v3/ai/MessageReader$ChatMsg;->isText()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v1, v1, Lcom/leshao/v3/ai/MessageReader$ChatMsg;->content:Ljava/lang/String;
    ...
    new-instance v7, Lcom/leshao/v3/ai/v1;

    invoke-direct {v7}, Lcom/leshao/v3/ai/v1;-><init>()V
    ...
    new-instance v0, Lcom/leshao/v3/ai/w1;

    invoke-direct {v0}, Lcom/leshao/v3/ai/w1;-><init>()V
...
.method private static findTitleBar(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    invoke-static {v1}, Lcom/leshao/v3/ai/SummaryFeature;->findTitleBar(Landroid/view/View;)Landroid/view/ViewGroup;
...
.method public static injectSummaryButton(Landroid/app/Activity;Ljava/lang/ClassLoader;)V
    ...
    new-instance v3, Lcom/leshao/v3/ai/t1;

    invoke-direct {v3, p0, p1}, Lcom/leshao/v3/ai/t1;-><init>(Landroid/app/Activity;Ljava/lang/ClassLoader;)V
...
.method private static synthetic lambda$doSummary$1(Ljava/util/List;Landroid/app/Activity;)V
    ...
    invoke-virtual {p0}, Lcom/leshao/v3/ai/SummaryFeature$SummaryStats;->toDataSummary()Ljava/lang/String;
    ...
    new-instance v3, Lcom/leshao/v3/ai/AiClient$ChatMessage;
    ...
    invoke-direct {v3, v1, v0}, Lcom/leshao/v3/ai/AiClient$ChatMessage;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v1, Lcom/leshao/v3/ai/SummaryFeature$1;

    invoke-direct {v1, p1, p0}, Lcom/leshao/v3/ai/SummaryFeature$1;-><init>(Landroid/app/Activity;Lcom/leshao/v3/ai/SummaryFeature$SummaryStats;)V

    invoke-static {v0, v2, v1}, Lcom/leshao/v3/ai/AiClient;->chatAsync(Ljava/lang/String;Ljava/util/List;Lcom/leshao/v3/ai/AiClient$Callback;)V
...
.method private static synthetic lambda$doSummary$2(Ljava/lang/ClassLoader;Ljava/lang/String;Landroid/app/Activity;)V
    ...
    invoke-virtual {v0, p1, p0}, Lcom/leshao/v3/ai/MessageReader;->readRecentFull(Ljava/lang/String;I)Ljava/util/List;

    move-result-object p0

    sget-object p1, Lcom/leshao/v3/ai/ChatHooks;->MAIN:Landroid/os/Handler;

    new-instance v0, Lcom/leshao/v3/ai/u1;

    invoke-direct {v0, p0, p2}, Lcom/leshao/v3/ai/u1;-><init>(Ljava/util/List;Landroid/app/Activity;)V
