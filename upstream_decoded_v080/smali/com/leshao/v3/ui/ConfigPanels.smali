...
.method public static synthetic a(Ljava/util/Set;Lcom/leshao/v3/model/Contact;Landroid/widget/CompoundButton;Z)V
    .locals 0

    .line 1
    invoke-static {p0, p1, p2, p3}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showContactPicker$21(Ljava/util/Set;Lcom/leshao/v3/model/Contact;Landroid/widget/CompoundButton;Z)V
...
.method private static addContactPickerRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/util/Set;)V
    ...
    invoke-static {p0, p2}, Lcom/leshao/v3/ui/ConfigPanels;->dp(Landroid/app/Activity;I)I
    ...
    new-instance p2, Lcom/leshao/v3/ui/z1;

    invoke-direct {p2, p0, p3}, Lcom/leshao/v3/ui/z1;-><init>(Landroid/app/Activity;Ljava/util/Set;)V
...
.method private static addEditRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/lang/String;I)Landroid/widget/EditText;
    ...
    invoke-static {p0, p3}, Lcom/leshao/v3/ui/ConfigPanels;->dp(Landroid/app/Activity;I)I
...
.method public static synthetic b(Landroid/content/SharedPreferences;Landroid/widget/EditText;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showAnonymousName$13(Landroid/content/SharedPreferences;Landroid/widget/EditText;)V
...
.method public static synthetic c(Landroid/widget/EditText;Landroid/content/SharedPreferences;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showSnsTimeOffset$12(Landroid/widget/EditText;Landroid/content/SharedPreferences;)V
...
.method public static synthetic d(Landroid/content/SharedPreferences;Landroid/widget/LinearLayout;Landroid/widget/LinearLayout;)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showRedAlert$11(Landroid/content/SharedPreferences;Landroid/widget/LinearLayout;Landroid/widget/LinearLayout;)V
...
.method public static synthetic e(Landroid/app/Activity;Ljava/util/Set;Landroid/view/View;)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$addContactPickerRow$20(Landroid/app/Activity;Ljava/util/Set;Landroid/view/View;)V
...
.method public static synthetic f(Landroid/widget/EditText;Landroid/content/SharedPreferences;Landroid/widget/EditText;)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showBatchMessage$4(Landroid/widget/EditText;Landroid/content/SharedPreferences;Landroid/widget/EditText;)V
...
.method private static fieldCheck(Landroid/app/Activity;FLjava/lang/String;Ljava/lang/String;ZLandroid/content/SharedPreferences;)Landroid/widget/LinearLayout;
    ...
    new-instance p0, Lcom/leshao/v3/ui/b2;

    invoke-direct {p0, p5, p2}, Lcom/leshao/v3/ui/b2;-><init>(Landroid/content/SharedPreferences;Ljava/lang/String;)V
...
.method public static synthetic g(Landroid/widget/EditText;)V
    ...
    .line 1
    invoke-static {p0}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showSearchEnhance$6(Landroid/widget/EditText;)V
...
.method public static synthetic h(Landroid/content/SharedPreferences;Ljava/lang/String;Landroid/widget/CompoundButton;Z)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$fieldCheck$18(Landroid/content/SharedPreferences;Ljava/lang/String;Landroid/widget/CompoundButton;Z)V
...
.method public static synthetic i(Landroid/content/SharedPreferences;Landroid/widget/Spinner;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showShakeCustom$9(Landroid/content/SharedPreferences;Landroid/widget/Spinner;)V
...
.method public static synthetic j(Ljava/lang/Runnable;Landroid/app/Activity;Landroid/content/DialogInterface;I)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showDialog$23(Ljava/lang/Runnable;Landroid/app/Activity;Landroid/content/DialogInterface;I)V
...
.method public static synthetic k(Landroid/widget/EditText;Landroid/widget/EditText;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showChatFooterEnhance$3(Landroid/widget/EditText;Landroid/widget/EditText;)V
...
.method public static synthetic l(Landroid/widget/Switch;Landroid/widget/Switch;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showAutoRemark$5(Landroid/widget/Switch;Landroid/widget/Switch;)V
...
.method private static synthetic lambda$showAutoRemark$5(Landroid/widget/Switch;Landroid/widget/Switch;)V
    ...
    sput-boolean p0, Lcom/leshao/v3/hook/AutoRemark;->autoFillFromGroupNick:Z

    invoke-virtual {p1}, Landroid/widget/CompoundButton;->isChecked()Z

    move-result p0

    sput-boolean p0, Lcom/leshao/v3/hook/AutoRemark;->autoFillFromCard:Z
...
.method private static synthetic lambda$showBatchMessage$4(Landroid/widget/EditText;Landroid/content/SharedPreferences;Landroid/widget/EditText;)V
    ...
    sput p0, Lcom/leshao/v3/hook/BatchMessage;->maxSelectCount:I
    ...
    sput p0, Lcom/leshao/v3/hook/BatchMessage;->forwardSplitSize:I
...
.method private static synthetic lambda$showChatFooterEnhance$3(Landroid/widget/EditText;Landroid/widget/EditText;)V
    ...
    sput p0, Lcom/leshao/v3/hook/ChatFooterEnhance;->maxTextLength:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    sput p0, Lcom/leshao/v3/hook/ChatFooterEnhance;->maxLines:I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
...
.method private static synthetic lambda$showChatUICustom$0(Landroid/content/SharedPreferences;Landroid/widget/EditText;Landroid/widget/EditText;Landroid/widget/EditText;Landroid/widget/EditText;Landroid/widget/EditText;Landroid/widget/Switch;)V
    ...
    invoke-static {p1}, Lcom/leshao/v3/ui/ConfigPanels;->parseColor(Ljava/lang/String;)I
    ...
    invoke-static {p2}, Lcom/leshao/v3/ui/ConfigPanels;->parseColor(Ljava/lang/String;)I
    ...
    invoke-static {p3}, Lcom/leshao/v3/ui/ConfigPanels;->parseColor(Ljava/lang/String;)I
...
.method private static synthetic lambda$showContactPicker$21(Ljava/util/Set;Lcom/leshao/v3/model/Contact;Landroid/widget/CompoundButton;Z)V
    .locals 0
...
.method private static synthetic lambda$showContactPicker$22(Landroid/widget/LinearLayout;Landroid/widget/EditText;Ljava/util/List;Landroid/app/Activity;Ljava/util/Set;)V
    ...
    check-cast v0, Lcom/leshao/v3/model/Contact;

    if-eqz v0, :cond_0

    iget-object v1, v0, Lcom/leshao/v3/model/Contact;->wxid:Ljava/lang/String;
    ...
    :cond_1
    iget-object v2, v0, Lcom/leshao/v3/model/Contact;->nickname:Ljava/lang/String;
    ...
    iget-object v2, v0, Lcom/leshao/v3/model/Contact;->wxid:Ljava/lang/String;
    ...
    invoke-static {p3, v4}, Lcom/leshao/v3/ui/ConfigPanels;->dp(Landroid/app/Activity;I)I
    ...
    new-instance v1, Lcom/leshao/v3/ui/g2;

    invoke-direct {v1, p4, v0}, Lcom/leshao/v3/ui/g2;-><init>(Ljava/util/Set;Lcom/leshao/v3/model/Contact;)V
...
.method private static synthetic lambda$showSearchEnhance$6(Landroid/widget/EditText;)V
    ...
    sput p0, Lcom/leshao/v3/hook/SearchEnhance;->maxResults:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static synthetic lambda$showStickyEnhance$19(Landroid/widget/EditText;)V
    ...
    sput p0, Lcom/leshao/v3/hook/StickyEnhance;->maxSticky:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static synthetic lambda$showTabCustom$8(Landroid/widget/Switch;Landroid/widget/EditText;Landroid/content/SharedPreferences;[Landroid/widget/LinearLayout;)V
    ...
    sput-object p0, Lcom/leshao/v3/hook/TabCustom;->hiddenTabs:[I
    ...
    :cond_9
    sput-object p1, Lcom/leshao/v3/hook/TabCustom;->hiddenTabs:[I
...
.method public static synthetic m(Landroid/widget/Switch;Landroid/widget/EditText;Landroid/content/SharedPreferences;[Landroid/widget/LinearLayout;)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showTabCustom$8(Landroid/widget/Switch;Landroid/widget/EditText;Landroid/content/SharedPreferences;[Landroid/widget/LinearLayout;)V
...
.method public static synthetic n([Ljava/lang/String;Landroid/content/SharedPreferences;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showHideContactFields$17([Ljava/lang/String;Landroid/content/SharedPreferences;)V
...
.method public static synthetic o(Landroid/widget/LinearLayout;Landroid/widget/EditText;Ljava/util/List;Landroid/app/Activity;Ljava/util/Set;)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3, p4}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showContactPicker$22(Landroid/widget/LinearLayout;Landroid/widget/EditText;Ljava/util/List;Landroid/app/Activity;Ljava/util/Set;)V
...
.method public static synthetic p(Landroid/content/SharedPreferences;Landroid/widget/Switch;Ljava/util/Set;)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showFriendRequest$16(Landroid/content/SharedPreferences;Landroid/widget/Switch;Ljava/util/Set;)V
...
.method public static synthetic q(Landroid/content/SharedPreferences;Landroid/widget/Spinner;Landroid/widget/EditText;Landroid/widget/EditText;)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showUnreadBadge$7(Landroid/content/SharedPreferences;Landroid/widget/Spinner;Landroid/widget/EditText;Landroid/widget/EditText;)V
...
.method public static synthetic r(Landroid/content/SharedPreferences;Landroid/widget/Spinner;Landroid/widget/Switch;Landroid/widget/Switch;Ljava/util/Set;)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3, p4}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showConvPrivacy$14(Landroid/content/SharedPreferences;Landroid/widget/Spinner;Landroid/widget/Switch;Landroid/widget/Switch;Ljava/util/Set;)V
...
.method public static synthetic s(Ljava/util/Set;Landroid/content/SharedPreferences;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showCallFeatures$10(Ljava/util/Set;Landroid/content/SharedPreferences;)V
...
.method public static showAnonymousName(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    new-instance v2, Lcom/leshao/v3/ui/ConfigPanels$13;

    invoke-direct {v2, p0, v0}, Lcom/leshao/v3/ui/ConfigPanels$13;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V

    new-instance v0, Lcom/leshao/v3/ui/j2;

    invoke-direct {v0, p1, v1}, Lcom/leshao/v3/ui/j2;-><init>(Landroid/content/SharedPreferences;Landroid/widget/EditText;)V

    const-string p1, "\u533f\u540d\u540d\u79f0\u914d\u7f6e"

    invoke-static {p0, p1, v2, v0}, Lcom/leshao/v3/ui/ConfigPanels;->showDialog(Landroid/app/Activity;Ljava/lang/String;Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public static showAutoRemark(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    sget-boolean v2, Lcom/leshao/v3/hook/AutoRemark;->autoFillFromGroupNick:Z

    invoke-static {p0, p1, v1, v2}, Lcom/leshao/v3/ui/ConfigPanels;->addSwitchRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Z)Landroid/widget/LinearLayout;
    ...
    invoke-static {p0, p1, v2, v3}, Lcom/leshao/v3/ui/ConfigPanels;->addSwitchRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Z)Landroid/widget/LinearLayout;
    ...
    new-instance v2, Lcom/leshao/v3/ui/ConfigPanels$5;

    invoke-direct {v2, p0, p1}, Lcom/leshao/v3/ui/ConfigPanels$5;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V

    new-instance p1, Lcom/leshao/v3/ui/y1;

    invoke-direct {p1, v1, v0}, Lcom/leshao/v3/ui/y1;-><init>(Landroid/widget/Switch;Landroid/widget/Switch;)V

    const-string v0, "\u81ea\u52a8\u5907\u6ce8\u914d\u7f6e"

    invoke-static {p0, v0, v2, p1}, Lcom/leshao/v3/ui/ConfigPanels;->showDialog(Landroid/app/Activity;Ljava/lang/String;Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public static showBatchMessage(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    invoke-static {p0, v0, v3, v1}, Lcom/leshao/v3/ui/ConfigPanels;->addIntRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/lang/String;)Landroid/widget/EditText;
    ...
    invoke-static {p0, v0, v3, v2}, Lcom/leshao/v3/ui/ConfigPanels;->addIntRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/lang/String;)Landroid/widget/EditText;

    move-result-object v2

    new-instance v3, Lcom/leshao/v3/ui/ConfigPanels$4;

    invoke-direct {v3, p0, v0}, Lcom/leshao/v3/ui/ConfigPanels$4;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V

    new-instance v0, Lcom/leshao/v3/ui/q1;

    invoke-direct {v0, v1, p1, v2}, Lcom/leshao/v3/ui/q1;-><init>(Landroid/widget/EditText;Landroid/content/SharedPreferences;Landroid/widget/EditText;)V

    const-string p1, "\u6279\u91cf\u6d88\u606f\u914d\u7f6e"

    invoke-static {p0, p1, v3, v0}, Lcom/leshao/v3/ui/ConfigPanels;->showDialog(Landroid/app/Activity;Ljava/lang/String;Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public static showCallFeatures(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    new-instance v2, Lcom/leshao/v3/ui/ConfigPanels$10;

    invoke-direct {v2, p0, v0}, Lcom/leshao/v3/ui/ConfigPanels$10;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V

    new-instance v0, Lcom/leshao/v3/ui/u1;

    invoke-direct {v0, v1, p1}, Lcom/leshao/v3/ui/u1;-><init>(Ljava/util/Set;Landroid/content/SharedPreferences;)V
...
.method public static showChatFooterEnhance(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    invoke-static {p0, v0}, Lcom/leshao/v3/ui/ConfigPanels;->dp(Landroid/app/Activity;I)I
    ...
    invoke-static {p0, p1, v0, v1}, Lcom/leshao/v3/ui/ConfigPanels;->addIntRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/lang/String;)Landroid/widget/EditText;
    ...
    invoke-static {p0, p1, v1, v2}, Lcom/leshao/v3/ui/ConfigPanels;->addIntRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/lang/String;)Landroid/widget/EditText;

    move-result-object v1

    new-instance v2, Lcom/leshao/v3/ui/ConfigPanels$3;

    invoke-direct {v2, p0, p1}, Lcom/leshao/v3/ui/ConfigPanels$3;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V

    new-instance p1, Lcom/leshao/v3/ui/h2;

    invoke-direct {p1, v0, v1}, Lcom/leshao/v3/ui/h2;-><init>(Landroid/widget/EditText;Landroid/widget/EditText;)V
...
.method public static showChatUICustom(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    invoke-static {p0, v0, v10, v3}, Lcom/leshao/v3/ui/ConfigPanels;->addColorRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/lang/String;)Landroid/widget/EditText;

    move-result-object v3

    const-string v10, "\u53d1\u9001\u6c14\u6ce1\u8272"

    invoke-static {v5}, Lcom/leshao/v3/ui/ConfigPanels;->colorToHex(I)Ljava/lang/String;

    move-result-object v5

    invoke-static {p0, v0, v10, v5}, Lcom/leshao/v3/ui/ConfigPanels;->addColorRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/lang/String;)Landroid/widget/EditText;

    move-result-object v5

    const-string v10, "\u63a5\u6536\u6c14\u6ce1\u8272"

    invoke-static {v6}, Lcom/leshao/v3/ui/ConfigPanels;->colorToHex(I)Ljava/lang/String;

    move-result-object v6

    invoke-static {p0, v0, v10, v6}, Lcom/leshao/v3/ui/ConfigPanels;->addColorRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/lang/String;)Landroid/widget/EditText;

    move-result-object v6

    const-string v10, "\u6807\u9898\u680f\u989c\u8272"

    invoke-static {v9}, Lcom/leshao/v3/ui/ConfigPanels;->colorToHex(I)Ljava/lang/String;

    move-result-object v9

    invoke-static {p0, v0, v10, v9}, Lcom/leshao/v3/ui/ConfigPanels;->addColorRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/lang/String;)Landroid/widget/EditText;
    ...
    invoke-static {p0, v0, v10, v7}, Lcom/leshao/v3/ui/ConfigPanels;->addIntRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/lang/String;)Landroid/widget/EditText;

    move-result-object v7

    const-string v10, "\u9690\u85cf\u6635\u79f0"

    invoke-static {p0, v0, v10, v4}, Lcom/leshao/v3/ui/ConfigPanels;->addSwitchRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Z)Landroid/widget/LinearLayout;
    ...
    new-instance v11, Lcom/leshao/v3/ui/l2;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/leshao/v3/ui/l2;-><init>(Landroid/content/SharedPreferences;Landroid/widget/EditText;Landroid/widget/EditText;Landroid/widget/EditText;Landroid/widget/EditText;Landroid/widget/EditText;Landroid/widget/Switch;)V

    const-string v0, "\u804a\u5929\u754c\u9762UI\u5b9a\u5236"

    invoke-static {p0, v0, v8, v11}, Lcom/leshao/v3/ui/ConfigPanels;->showDialog(Landroid/app/Activity;Ljava/lang/String;Landroid/view/View;Ljava/lang/Runnable;)V
...
.method private static showContactPicker(Landroid/app/Activity;Ljava/util/Set;)V
    ...
    new-instance v2, Lcom/leshao/v3/model/Contact;

    iget-object v5, v1, Lcom/leshao/v3/model/ContactCard;->username:Ljava/lang/String;

    invoke-virtual {v1}, Lcom/leshao/v3/model/ContactCard;->displayName()Ljava/lang/String;

    move-result-object v6

    iget-object v7, v1, Lcom/leshao/v3/model/ContactCard;->conRemark:Ljava/lang/String;

    iget-object v8, v1, Lcom/leshao/v3/model/ContactCard;->alias:Ljava/lang/String;

    iget v9, v1, Lcom/leshao/v3/model/ContactCard;->type:I

    move-object v4, v2

    invoke-direct/range {v4 .. v9}, Lcom/leshao/v3/model/Contact;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    new-instance v8, Lcom/leshao/v3/ui/r1;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/leshao/v3/ui/r1;-><init>(Landroid/widget/LinearLayout;Landroid/widget/EditText;Ljava/util/List;Landroid/app/Activity;Ljava/util/Set;)V

    new-instance p1, Lcom/leshao/v3/ui/ConfigPanels$19;

    invoke-direct {p1, v8}, Lcom/leshao/v3/ui/ConfigPanels$19;-><init>(Ljava/lang/Runnable;)V
...
.method public static showConvPrivacy(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    invoke-static {p0, v0, v6, v2, v5}, Lcom/leshao/v3/ui/ConfigPanels;->addSpinnerRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;I[Ljava/lang/String;)Landroid/widget/Spinner;
    ...
    invoke-static {p0, v0, v2, v4}, Lcom/leshao/v3/ui/ConfigPanels;->addSwitchRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Z)Landroid/widget/LinearLayout;
    ...
    invoke-static {p0, v0, v1, v10}, Lcom/leshao/v3/ui/ConfigPanels;->addContactPickerRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/util/Set;)V

    invoke-static {p0, v0, v10}, Lcom/leshao/v3/ui/ConfigPanels;->addSelectedLabel(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/util/Set;)Landroid/widget/TextView;

    new-instance v1, Lcom/leshao/v3/ui/ConfigPanels$14;

    invoke-direct {v1, p0, v0}, Lcom/leshao/v3/ui/ConfigPanels$14;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V

    new-instance v0, Lcom/leshao/v3/ui/d2;

    move-object v5, v0

    move-object v6, p1

    invoke-direct/range {v5 .. v10}, Lcom/leshao/v3/ui/d2;-><init>(Landroid/content/SharedPreferences;Landroid/widget/Spinner;Landroid/widget/Switch;Landroid/widget/Switch;Ljava/util/Set;)V

    const-string p1, "\u4f1a\u8bdd\u9690\u79c1\u914d\u7f6e"

    invoke-static {p0, p1, v1, v0}, Lcom/leshao/v3/ui/ConfigPanels;->showDialog(Landroid/app/Activity;Ljava/lang/String;Landroid/view/View;Ljava/lang/Runnable;)V
...
.method private static showDialog(Landroid/app/Activity;Ljava/lang/String;Landroid/view/View;Ljava/lang/Runnable;)V
    ...
    new-instance p2, Lcom/leshao/v3/ui/w1;

    invoke-direct {p2, p3, p0}, Lcom/leshao/v3/ui/w1;-><init>(Ljava/lang/Runnable;Landroid/app/Activity;)V
...
.method public static showFingerprintLock(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    new-instance v2, Lcom/leshao/v3/ui/ConfigPanels$15;

    invoke-direct {v2, p0, v0}, Lcom/leshao/v3/ui/ConfigPanels$15;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V

    new-instance v0, Lcom/leshao/v3/ui/v1;

    invoke-direct {v0, v1, p1}, Lcom/leshao/v3/ui/v1;-><init>(Ljava/util/Set;Landroid/content/SharedPreferences;)V
...
.method public static showFriendRequest(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    invoke-static {p0, v0, v2, v5}, Lcom/leshao/v3/ui/ConfigPanels;->addContactPickerRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/util/Set;)V
    ...
    new-instance v2, Lcom/leshao/v3/ui/ConfigPanels$16;

    invoke-direct {v2, p0, v0}, Lcom/leshao/v3/ui/ConfigPanels$16;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V

    new-instance v0, Lcom/leshao/v3/ui/x1;

    invoke-direct {v0, p1, v1, v5}, Lcom/leshao/v3/ui/x1;-><init>(Landroid/content/SharedPreferences;Landroid/widget/Switch;Ljava/util/Set;)V
...
.method public static showHideContactFields(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    new-instance v1, Lcom/leshao/v3/ui/s1;

    move-object/from16 v2, p1

    invoke-direct {v1, v9, v2}, Lcom/leshao/v3/ui/s1;-><init>([Ljava/lang/String;Landroid/content/SharedPreferences;)V

    const-string v2, "\u9690\u85cf\u5b57\u6bb5\u914d\u7f6e"

    invoke-static {v6, v2, v0, v1}, Lcom/leshao/v3/ui/ConfigPanels;->showDialog(Landroid/app/Activity;Ljava/lang/String;Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public static showNotifyCustom(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    invoke-static {p0, v0, v9, v3, v8}, Lcom/leshao/v3/ui/ConfigPanels;->addSpinnerRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;I[Ljava/lang/String;)Landroid/widget/Spinner;

    move-result-object v3

    const-string v8, "\u663e\u793a\u901a\u77e5\u5934\u50cf"

    invoke-static {p0, v0, v8, v5}, Lcom/leshao/v3/ui/ConfigPanels;->addSwitchRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Z)Landroid/widget/LinearLayout;
    ...
    invoke-static {p0, v0, v2, v8}, Lcom/leshao/v3/ui/ConfigPanels;->addContactPickerRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/util/Set;)V

    invoke-static {p0, v0, v8}, Lcom/leshao/v3/ui/ConfigPanels;->addSelectedLabel(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/util/Set;)Landroid/widget/TextView;

    const-string v2, "\u5feb\u6377\u56de\u590d\u77ed\u8bed (|\u5206\u9694)"

    invoke-static {p0, v0, v2, v7}, Lcom/leshao/v3/ui/ConfigPanels;->addTextRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/lang/String;)Landroid/widget/EditText;

    move-result-object v6

    new-instance v7, Lcom/leshao/v3/ui/ConfigPanels$1;

    invoke-direct {v7, p0, v0}, Lcom/leshao/v3/ui/ConfigPanels$1;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V

    new-instance v9, Lcom/leshao/v3/ui/t1;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/leshao/v3/ui/t1;-><init>(Landroid/content/SharedPreferences;Landroid/widget/Spinner;Landroid/widget/Switch;Ljava/util/Set;Landroid/widget/EditText;)V

    const-string v0, "\u901a\u77e5\u81ea\u5b9a\u4e49\u914d\u7f6e"

    invoke-static {p0, v0, v7, v9}, Lcom/leshao/v3/ui/ConfigPanels;->showDialog(Landroid/app/Activity;Ljava/lang/String;Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public static showRedAlert(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    invoke-static {p0, v0, v3, v1}, Lcom/leshao/v3/ui/ConfigPanels;->addSwitchRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Z)Landroid/widget/LinearLayout;

    move-result-object v1

    new-instance v3, Lcom/leshao/v3/ui/ConfigPanels$11;

    invoke-direct {v3, p0, v0}, Lcom/leshao/v3/ui/ConfigPanels$11;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V

    new-instance v0, Lcom/leshao/v3/ui/f2;

    invoke-direct {v0, p1, v2, v1}, Lcom/leshao/v3/ui/f2;-><init>(Landroid/content/SharedPreferences;Landroid/widget/LinearLayout;Landroid/widget/LinearLayout;)V
...
.method public static showSearchEnhance(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    new-instance v1, Lcom/leshao/v3/ui/ConfigPanels$6;

    invoke-direct {v1, p0, p1}, Lcom/leshao/v3/ui/ConfigPanels$6;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V

    new-instance p1, Lcom/leshao/v3/ui/e2;

    invoke-direct {p1, v0}, Lcom/leshao/v3/ui/e2;-><init>(Landroid/widget/EditText;)V

    const-string v0, "\u641c\u7d22\u589e\u5f3a\u914d\u7f6e"

    invoke-static {p0, v0, v1, p1}, Lcom/leshao/v3/ui/ConfigPanels;->showDialog(Landroid/app/Activity;Ljava/lang/String;Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public static showShakeCustom(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    new-instance v2, Lcom/leshao/v3/ui/ConfigPanels$9;

    invoke-direct {v2, p0, v0}, Lcom/leshao/v3/ui/ConfigPanels$9;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V

    new-instance v0, Lcom/leshao/v3/ui/p1;

    invoke-direct {v0, p1, v1}, Lcom/leshao/v3/ui/p1;-><init>(Landroid/content/SharedPreferences;Landroid/widget/Spinner;)V
...
.method public static showSnsTimeOffset(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    new-instance v2, Lcom/leshao/v3/ui/ConfigPanels$12;

    invoke-direct {v2, p0, v0}, Lcom/leshao/v3/ui/ConfigPanels$12;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V

    new-instance v0, Lcom/leshao/v3/ui/o1;

    invoke-direct {v0, v1, p1}, Lcom/leshao/v3/ui/o1;-><init>(Landroid/widget/EditText;Landroid/content/SharedPreferences;)V
...
.method public static showStickyEnhance(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    sget v0, Lcom/leshao/v3/hook/StickyEnhance;->maxSticky:I
    ...
    invoke-static {p0, p1, v1, v0}, Lcom/leshao/v3/ui/ConfigPanels;->addIntRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/lang/String;)Landroid/widget/EditText;

    move-result-object v0

    new-instance v1, Lcom/leshao/v3/ui/ConfigPanels$18;

    invoke-direct {v1, p0, p1}, Lcom/leshao/v3/ui/ConfigPanels$18;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V

    new-instance p1, Lcom/leshao/v3/ui/c2;

    invoke-direct {p1, v0}, Lcom/leshao/v3/ui/c2;-><init>(Landroid/widget/EditText;)V
...
.method public static showTabCustom(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    invoke-static {p0, v0, v8, v9}, Lcom/leshao/v3/ui/ConfigPanels;->addSwitchRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Z)Landroid/widget/LinearLayout;
    ...
    :cond_2
    new-instance v3, Lcom/leshao/v3/ui/ConfigPanels$8;

    invoke-direct {v3, p0, v0}, Lcom/leshao/v3/ui/ConfigPanels$8;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V

    new-instance v0, Lcom/leshao/v3/ui/i2;

    invoke-direct {v0, v1, v2, p1, v7}, Lcom/leshao/v3/ui/i2;-><init>(Landroid/widget/Switch;Landroid/widget/EditText;Landroid/content/SharedPreferences;[Landroid/widget/LinearLayout;)V
...
.method public static showTypingIndicator(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    new-instance v2, Lcom/leshao/v3/ui/ConfigPanels$2;

    invoke-direct {v2, p0, v0}, Lcom/leshao/v3/ui/ConfigPanels$2;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V

    new-instance v0, Lcom/leshao/v3/ui/a2;

    invoke-direct {v0, p1, v1}, Lcom/leshao/v3/ui/a2;-><init>(Landroid/content/SharedPreferences;Landroid/widget/Switch;)V
...
.method public static showUnreadBadge(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    invoke-static {p0, v0, v4, v2}, Lcom/leshao/v3/ui/ConfigPanels;->addIntRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/lang/String;)Landroid/widget/EditText;
    ...
    invoke-static {p0, v0, v4, v3}, Lcom/leshao/v3/ui/ConfigPanels;->addColorRow(Landroid/app/Activity;Landroid/widget/LinearLayout;Ljava/lang/String;Ljava/lang/String;)Landroid/widget/EditText;

    move-result-object v3

    new-instance v4, Lcom/leshao/v3/ui/ConfigPanels$7;

    invoke-direct {v4, p0, v0}, Lcom/leshao/v3/ui/ConfigPanels$7;-><init>(Landroid/content/Context;Landroid/widget/LinearLayout;)V

    new-instance v0, Lcom/leshao/v3/ui/k2;

    invoke-direct {v0, p1, v1, v2, v3}, Lcom/leshao/v3/ui/k2;-><init>(Landroid/content/SharedPreferences;Landroid/widget/Spinner;Landroid/widget/EditText;Landroid/widget/EditText;)V

    const-string p1, "\u672a\u8bfb\u89d2\u6807\u914d\u7f6e"

    invoke-static {p0, p1, v4, v0}, Lcom/leshao/v3/ui/ConfigPanels;->showDialog(Landroid/app/Activity;Ljava/lang/String;Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public static synthetic t(Landroid/content/SharedPreferences;Landroid/widget/Switch;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showTypingIndicator$2(Landroid/content/SharedPreferences;Landroid/widget/Switch;)V
...
.method public static synthetic u(Landroid/widget/EditText;)V
    ...
    .line 1
    invoke-static {p0}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showStickyEnhance$19(Landroid/widget/EditText;)V
...
.method public static synthetic v(Landroid/content/SharedPreferences;Landroid/widget/Spinner;Landroid/widget/Switch;Ljava/util/Set;Landroid/widget/EditText;)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3, p4}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showNotifyCustom$1(Landroid/content/SharedPreferences;Landroid/widget/Spinner;Landroid/widget/Switch;Ljava/util/Set;Landroid/widget/EditText;)V
...
.method public static synthetic w(Ljava/util/Set;Landroid/content/SharedPreferences;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showFingerprintLock$15(Ljava/util/Set;Landroid/content/SharedPreferences;)V
...
.method public static synthetic x(Landroid/content/SharedPreferences;Landroid/widget/EditText;Landroid/widget/EditText;Landroid/widget/EditText;Landroid/widget/EditText;Landroid/widget/EditText;Landroid/widget/Switch;)V
    ...
    .line 1
    invoke-static/range {p0 .. p6}, Lcom/leshao/v3/ui/ConfigPanels;->lambda$showChatUICustom$0(Landroid/content/SharedPreferences;Landroid/widget/EditText;Landroid/widget/EditText;Landroid/widget/EditText;Landroid/widget/EditText;Landroid/widget/EditText;Landroid/widget/Switch;)V
