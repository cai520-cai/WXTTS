...
.method public static synthetic a(Landroid/app/Activity;Landroid/content/SharedPreferences;Landroid/view/View;)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lcom/leshao/v3/ui/PrivacyPageView;->lambda$create$1(Landroid/app/Activity;Landroid/content/SharedPreferences;Landroid/view/View;)V
...
.method public static synthetic b(Lcom/leshao/v3/model/ModuleConfig;Landroid/content/SharedPreferences;Landroid/widget/CompoundButton;Z)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3}, Lcom/leshao/v3/ui/PrivacyPageView;->lambda$create$3(Lcom/leshao/v3/model/ModuleConfig;Landroid/content/SharedPreferences;Landroid/widget/CompoundButton;Z)V
...
.method public static synthetic c(Lcom/leshao/v3/model/ModuleConfig;Landroid/content/SharedPreferences;Landroid/widget/CompoundButton;Z)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3}, Lcom/leshao/v3/ui/PrivacyPageView;->lambda$create$2(Lcom/leshao/v3/model/ModuleConfig;Landroid/content/SharedPreferences;Landroid/widget/CompoundButton;Z)V
...
.method public static create(Landroid/content/Context;Landroid/app/Activity;)Landroid/view/View;
    ...
    invoke-static {p0, v2, v3}, Lcom/leshao/v3/ui/PrivacyPageView;->sLabel(Landroid/content/Context;FLjava/lang/String;)Landroid/widget/TextView;

    move-result-object v3

    invoke-virtual {v10, v3}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    invoke-static {p0, v2}, Lcom/leshao/v3/ui/PrivacyPageView;->makeCard(Landroid/content/Context;F)Landroid/widget/LinearLayout;
    ...
    iget-boolean v7, v1, Lcom/leshao/v3/model/ModuleConfig;->privacyFeaturesEnabled:Z

    new-instance v8, Lcom/leshao/v3/ui/p6;

    invoke-direct {v8, v1, v0}, Lcom/leshao/v3/ui/p6;-><init>(Lcom/leshao/v3/model/ModuleConfig;Landroid/content/SharedPreferences;)V

    new-instance v9, Lcom/leshao/v3/ui/q6;

    invoke-direct {v9, p1, v0}, Lcom/leshao/v3/ui/q6;-><init>(Landroid/app/Activity;Landroid/content/SharedPreferences;)V

    move-object v3, p0

    move v4, v2

    invoke-static/range {v3 .. v9}, Lcom/leshao/v3/ui/PrivacyPageView;->switchRow(Landroid/content/Context;FLjava/lang/String;Ljava/lang/String;ZLandroid/widget/CompoundButton$OnCheckedChangeListener;Landroid/view/View$OnClickListener;)Landroid/widget/LinearLayout;
    ...
    iget-boolean v7, v1, Lcom/leshao/v3/model/ModuleConfig;->loginMonitorEnabled:Z

    new-instance v8, Lcom/leshao/v3/ui/r6;

    invoke-direct {v8, v1, v0}, Lcom/leshao/v3/ui/r6;-><init>(Lcom/leshao/v3/model/ModuleConfig;Landroid/content/SharedPreferences;)V
    ...
    iget-boolean v7, v1, Lcom/leshao/v3/model/ModuleConfig;->hideContactFieldsEnabled:Z

    new-instance v8, Lcom/leshao/v3/ui/s6;

    invoke-direct {v8, v1, v0}, Lcom/leshao/v3/ui/s6;-><init>(Lcom/leshao/v3/model/ModuleConfig;Landroid/content/SharedPreferences;)V

    new-instance v9, Lcom/leshao/v3/ui/t6;

    invoke-direct {v9, p1, v0}, Lcom/leshao/v3/ui/t6;-><init>(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
    ...
    iget-boolean v7, v1, Lcom/leshao/v3/model/ModuleConfig;->convPrivacyEnabled:Z

    new-instance v8, Lcom/leshao/v3/ui/u6;

    invoke-direct {v8, v1, v0}, Lcom/leshao/v3/ui/u6;-><init>(Lcom/leshao/v3/model/ModuleConfig;Landroid/content/SharedPreferences;)V

    new-instance v9, Lcom/leshao/v3/ui/v6;

    invoke-direct {v9, p1, v0}, Lcom/leshao/v3/ui/v6;-><init>(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
...
.method public static synthetic d(Lcom/leshao/v3/model/ModuleConfig;Landroid/content/SharedPreferences;Landroid/widget/CompoundButton;Z)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3}, Lcom/leshao/v3/ui/PrivacyPageView;->lambda$create$5(Lcom/leshao/v3/model/ModuleConfig;Landroid/content/SharedPreferences;Landroid/widget/CompoundButton;Z)V
...
.method public static synthetic e(Landroid/app/Activity;Landroid/content/SharedPreferences;Landroid/view/View;)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lcom/leshao/v3/ui/PrivacyPageView;->lambda$create$6(Landroid/app/Activity;Landroid/content/SharedPreferences;Landroid/view/View;)V
...
.method public static synthetic f(Landroid/app/Activity;Landroid/content/SharedPreferences;Landroid/view/View;)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lcom/leshao/v3/ui/PrivacyPageView;->lambda$create$4(Landroid/app/Activity;Landroid/content/SharedPreferences;Landroid/view/View;)V

    return-void
.end method

.method public static synthetic g(Lcom/leshao/v3/model/ModuleConfig;Landroid/content/SharedPreferences;Landroid/widget/CompoundButton;Z)V
    .locals 0

    .line 1
    invoke-static {p0, p1, p2, p3}, Lcom/leshao/v3/ui/PrivacyPageView;->lambda$create$0(Lcom/leshao/v3/model/ModuleConfig;Landroid/content/SharedPreferences;Landroid/widget/CompoundButton;Z)V
