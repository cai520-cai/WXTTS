...
.method public static synthetic a(Landroid/widget/TextView;Landroid/widget/TextView;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/leshao/v3/ui/StatsPageView;->lambda$create$1(Landroid/widget/TextView;Landroid/widget/TextView;)V
...
.method public static synthetic b(Landroid/widget/TextView;Landroid/widget/TextView;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/leshao/v3/ui/StatsPageView;->lambda$create$0(Landroid/widget/TextView;Landroid/widget/TextView;)V
...
.method public static create(Landroid/content/Context;Landroid/app/Activity;)Landroid/view/View;
    ...
    invoke-static {p0, p1, v1}, Lcom/leshao/v3/ui/StatsPageView;->sLabel(Landroid/content/Context;FLjava/lang/String;)Landroid/widget/TextView;
    ...
    invoke-static {p0, p1, v3, v1}, Lcom/leshao/v3/ui/StatsPageView;->infoRow(Landroid/content/Context;FLjava/lang/String;Landroid/widget/TextView;)Landroid/widget/LinearLayout;
    ...
    invoke-static {p0, p1, v3, v2}, Lcom/leshao/v3/ui/StatsPageView;->infoRow(Landroid/content/Context;FLjava/lang/String;Landroid/widget/TextView;)Landroid/widget/LinearLayout;

    move-result-object v3

    invoke-virtual {v0, v3}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    invoke-static {v1, v2}, Lcom/leshao/v3/ui/StatsPageView;->updateCounts(Landroid/widget/TextView;Landroid/widget/TextView;)V

    new-instance v3, Lcom/leshao/v3/ui/c9;

    invoke-direct {v3, v1, v2}, Lcom/leshao/v3/ui/c9;-><init>(Landroid/widget/TextView;Landroid/widget/TextView;)V

    invoke-static {v3}, Lo5/g1;->m(Ljava/lang/Runnable;)V

    invoke-static {p0, p1}, Lcom/leshao/v3/ui/StatsPageView;->candyDivider(Landroid/content/Context;F)Landroid/view/View;
    ...
    invoke-static {p0, p1, v1}, Lcom/leshao/v3/ui/StatsPageView;->tv(Landroid/content/Context;FLjava/lang/String;)Landroid/widget/TextView;
    ...
    invoke-static {p0, p1, v3}, Lcom/leshao/v3/ui/StatsPageView;->tv(Landroid/content/Context;FLjava/lang/String;)Landroid/widget/TextView;
...
.method private static synthetic lambda$create$1(Landroid/widget/TextView;Landroid/widget/TextView;)V
    ...
    new-instance v1, Lcom/leshao/v3/ui/b9;

    invoke-direct {v1, p0, p1}, Lcom/leshao/v3/ui/b9;-><init>(Landroid/widget/TextView;Landroid/widget/TextView;)V
...
.method private static sLabel(Landroid/content/Context;FLjava/lang/String;)Landroid/widget/TextView;
    ...
    invoke-static {p1, p0}, Lcom/leshao/v3/ui/StatsPageView;->dp(FI)I

    move-result p0

    const/16 p2, 0x8

    invoke-static {p1, p2}, Lcom/leshao/v3/ui/StatsPageView;->dp(FI)I
