...
.method private static createBlueButton(Landroid/content/Context;Ljava/lang/String;ILandroid/view/View$OnClickListener;)Landroid/widget/TextView;
    ...
    invoke-static {v0, p0}, Lcom/leshao/v3/hook/ChatVoiceSwitchHook;->dp(ILandroid/content/Context;)I
    ...
    invoke-static {p1, p0}, Lcom/leshao/v3/hook/ChatVoiceSwitchHook;->dp(ILandroid/content/Context;)I
...
.method private static createButtonRow(Landroid/content/Context;)Landroid/widget/HorizontalScrollView;
    ...
    new-instance v3, Lcom/leshao/v3/hook/ChatVoiceSwitchHook$9;

    invoke-direct {v3, p0}, Lcom/leshao/v3/hook/ChatVoiceSwitchHook$9;-><init>(Landroid/content/Context;)V

    const-string v4, "\u7fa4\u53d1"

    const/4 v6, 0x2

    invoke-static {p0, v4, v6, v3}, Lcom/leshao/v3/hook/ChatVoiceSwitchHook;->createBlueButton(Landroid/content/Context;Ljava/lang/String;ILandroid/view/View$OnClickListener;)Landroid/widget/TextView;
    ...
    new-instance v3, Lcom/leshao/v3/hook/ChatVoiceSwitchHook$10;

    invoke-direct {v3, p0}, Lcom/leshao/v3/hook/ChatVoiceSwitchHook$10;-><init>(Landroid/content/Context;)V
    ...
    new-instance v0, Lcom/leshao/v3/hook/ChatVoiceSwitchHook$11;

    invoke-direct {v0}, Lcom/leshao/v3/hook/ChatVoiceSwitchHook$11;-><init>()V

    const-string v3, "\u8bed\u97f3"

    invoke-static {p0, v3, v6, v0}, Lcom/leshao/v3/hook/ChatVoiceSwitchHook;->createBlueButton(Landroid/content/Context;Ljava/lang/String;ILandroid/view/View$OnClickListener;)Landroid/widget/TextView;
...
.method private static hookActivityResume(Ljava/lang/ClassLoader;)V
    ...
    new-instance v2, Lcom/leshao/v3/hook/ChatVoiceSwitchHook$6;

    invoke-direct {v2}, Lcom/leshao/v3/hook/ChatVoiceSwitchHook$6;-><init>()V
...
.method private static hookMMEditText(Ljava/lang/ClassLoader;I)V
    ...
    new-instance v5, Lcom/leshao/v3/hook/ChatVoiceSwitchHook$1;

    invoke-direct {v5}, Lcom/leshao/v3/hook/ChatVoiceSwitchHook$1;-><init>()V
...
.method private static openMassSend(Landroid/content/Context;)V
    ...
    invoke-static {p0, v1}, Ls5/c2;->q3(Landroid/app/Activity;Ljava/lang/ClassLoader;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static openMasterPanel(Landroid/content/Context;Landroid/view/View;)V
    ...
    :cond_0
    :try_start_0
    invoke-static {p0}, Ls5/c2;->v3(Landroid/app/Activity;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static openTtsPage(Landroid/content/Context;)V
    ...
    invoke-static {v0, v0, p0}, Lcom/leshao/v3/ui/TTSPageView;->showTtsCubeDialog(Landroid/content/Context;Landroid/app/Activity;F)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static scanAndInject(Landroid/app/Activity;)V
    ...
    :cond_0
    invoke-static {p0}, Lcom/leshao/v3/hook/ChatVoiceSwitchHook;->findMMEditText(Landroid/view/View;)Landroid/view/View;
...
.method private static scheduleInject(Ljava/lang/Object;)V
    ...
    :cond_2
    invoke-static {v0}, Lcom/leshao/v3/hook/ChatVoiceSwitchHook;->getActivityFromContext(Landroid/content/Context;)Landroid/app/Activity;

    move-result-object v0

    if-eqz v0, :cond_8

    invoke-static {v0}, Lcom/leshao/v3/hook/ChatVoiceSwitchHook;->isChatPage(Landroid/app/Activity;)Z
    ...
    sget-object v1, Lcom/leshao/v3/hook/ChatVoiceSwitchHook;->PENDING_TAG:Ljava/lang/Object;
    ...
    sget-object v2, Lcom/leshao/v3/hook/ChatVoiceSwitchHook;->INJECTED_TAG:Ljava/lang/Object;
    ...
    new-instance v1, Lcom/leshao/v3/hook/ChatVoiceSwitchHook$7;

    invoke-direct {v1, p0}, Lcom/leshao/v3/hook/ChatVoiceSwitchHook$7;-><init>(Landroid/view/View;)V
