...
.method public static final a(Lw5/l0;)Ljava/util/Map;
    .locals 6
    .param p0    # Lw5/l0;
    ...
    new-instance v3, Lt6/k1$f;

    invoke-direct {v3}, Lt6/k1$f;-><init>()V

    :cond_1
    check-cast v3, Lt6/k1$f;

    iget v5, v3, Lt6/k1$f;->k:I

    add-int/2addr v5, v4

    iput v5, v3, Lt6/k1$f;->k:I
    ...
    invoke-static {v1, v2}, Lt6/l0;->n(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static {v1}, Lt6/u1;->m(Ljava/lang/Object;)Ljava/util/Map$Entry;
    ...
    check-cast v1, Lt6/k1$f;

    iget v1, v1, Lt6/k1$f;->k:I
    ...
    :cond_3
    invoke-static {v0}, Lt6/u1;->k(Ljava/lang/Object;)Ljava/util/Map;
