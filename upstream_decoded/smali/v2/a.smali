...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lv2/a;->i:Z

    sput-boolean v0, Lv2/a;->j:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lv2/a;->b:Landroid/graphics/BitmapFactory$Options;
...
.method public i(Landroid/net/Uri;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, p1, v0}, Lv2/a;->h(Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    iput-object v2, p0, Lv2/a;->b:Landroid/graphics/BitmapFactory$Options;
    ...
    :try_start_1
    invoke-virtual {p0, p1, v2}, Lv2/a;->h(Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :try_start_2
    iput-object v3, p0, Lv2/a;->b:Landroid/graphics/BitmapFactory$Options;
...
.method public j(Ljava/lang/String;Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lv2/a;->k(Ljava/lang/String;Landroid/graphics/Bitmap;Lv2/a$b;)V

    return-void
.end method

.method public k(Ljava/lang/String;Landroid/graphics/Bitmap;Lv2/a$b;)V
    .locals 9
    .param p1    # Ljava/lang/String;
        .annotation build Le/m0;
        .end annotation
    ...
    invoke-static {p2}, Lv2/a;->g(Landroid/graphics/Bitmap;)Z
    ...
    invoke-direct/range {v2 .. v7}, Lv2/a$c;-><init>(Lv2/a;Ljava/lang/String;ILandroid/graphics/Bitmap;Lv2/a$b;)V
...
.method public l(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lv2/a;->m(Ljava/lang/String;Landroid/net/Uri;Lv2/a$b;)V

    return-void
.end method

.method public m(Ljava/lang/String;Landroid/net/Uri;Lv2/a$b;)V
    .locals 7
    .param p1    # Ljava/lang/String;
        .annotation build Le/m0;
        .end annotation
    ...
    invoke-direct/range {v0 .. v5}, Lv2/a$d;-><init>(Lv2/a;Ljava/lang/String;Landroid/net/Uri;Lv2/a$b;I)V

    iget-object p2, p0, Lv2/a;->a:Landroid/content/Context;
...
.method public r(Landroid/print/PrintAttributes;ILandroid/graphics/Bitmap;Landroid/os/ParcelFileDescriptor;Landroid/os/CancellationSignal;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
    ...
    :cond_0
    invoke-static {p1}, Lv2/a;->b(Landroid/print/PrintAttributes;)Landroid/print/PrintAttributes$Builder;
    ...
    invoke-direct/range {v2 .. v10}, Lv2/a$a;-><init>(Lv2/a;Landroid/os/CancellationSignal;Landroid/print/PrintAttributes;Landroid/graphics/Bitmap;Landroid/print/PrintAttributes;ILandroid/os/ParcelFileDescriptor;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
