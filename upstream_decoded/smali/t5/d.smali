...
# static fields
.field public static final a:Ljava/lang/String; = "WmReflect"
...
.method public static C(Ljava/lang/ClassLoader;Ljava/lang/String;Ljava/util/List;)Z
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    invoke-static {p0, p1}, Lt5/d;->D(Ljava/lang/ClassLoader;Ljava/lang/String;)Z
...
.method public static D(Ljava/lang/ClassLoader;Ljava/lang/String;)Z
    .locals 2
    ...
    :cond_1
    :try_start_0
    invoke-static {p0}, Lt5/d;->k(Ljava/lang/ClassLoader;)Ljava/lang/Class;
...
.method public static E(Ljava/lang/ClassLoader;Ljava/lang/String;)Z
    .locals 0

    .line 1
    invoke-static {p0, p1}, Lt5/d;->z(Ljava/lang/ClassLoader;Ljava/lang/String;)I
...
.method public static F(Ljava/lang/ClassLoader;Ljava/lang/String;Ljava/lang/String;)Z
    .locals 4
...
.method public static synthetic G(Landroid/widget/ImageView;Landroid/graphics/Bitmap;)V
    .locals 0
...
.method public static synthetic H(Ljava/lang/String;Landroid/widget/ImageView;)V
    ...
    .line 1
    invoke-static {p0}, Lt5/d;->d(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v0, p1, p0}, Lt5/c;-><init>(Landroid/widget/ImageView;Landroid/graphics/Bitmap;)V
...
.method public static I(Ljava/lang/ClassLoader;Landroid/widget/ImageView;Ljava/lang/String;)V
    .locals 3
    ...
    :catch_0
    invoke-static {p0, p2}, Lt5/d;->h(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, p0, p1}, Lt5/b;-><init>(Ljava/lang/String;Landroid/widget/ImageView;)V
...
.method public static J(Ljava/lang/ClassLoader;Ljava/lang/String;Ljava/lang/String;)V
    .locals 1

    .line 1
    invoke-static {p0}, Lt5/d;->A(Ljava/lang/ClassLoader;)Ljava/lang/Object;
    ...
    const-string p2, "sendTextMsg err: "
...
.method public static synthetic a(Ljava/lang/String;Landroid/widget/ImageView;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lt5/d;->H(Ljava/lang/String;Landroid/widget/ImageView;)V
...
.method public static synthetic b(Landroid/widget/ImageView;Landroid/graphics/Bitmap;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lt5/d;->G(Landroid/widget/ImageView;Landroid/graphics/Bitmap;)V

    return-void
.end method

.method public static c(Ljava/lang/ClassLoader;Ljava/util/List;Ljava/lang/String;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_2
    invoke-static {p0, p2, v0}, Lt5/d;->J(Ljava/lang/ClassLoader;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static d(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1}, Lt5/d;->K(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
...
.method public static e(Ljava/lang/ClassLoader;)Ljava/lang/Class;
    ...
    const-string v1, "getChatroomInfo: chatroom iface cw1.f not found: "
...
.method public static g(Ljava/lang/ClassLoader;)Ljava/util/List;
    ...
    invoke-static {p0}, Lt5/d;->m(Ljava/lang/ClassLoader;)Ljava/lang/Object;
...
.method public static h(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/String;
    .locals 8

    .line 1
    invoke-static {p0, p1}, Lt5/d;->l(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Object;
    ...
    :cond_0
    const-string v0, "field_headImgUrl"

    const-string v1, "field_avatarUrl"

    const-string v2, "field_avatarBUrl"

    const-string v3, "field_headimgurl"

    const-string v4, "field_avatarurl"

    const-string v5, "field_avatar_full_url"

    const-string v6, "field_smallHeadImgUrl"

    const-string v7, "field_encryptUsername"
...
.method public static j(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Object;
    .locals 6
    ...
    :cond_0
    sget-object v2, Lt5/d;->b:Ljava/lang/Class;

    if-nez v2, :cond_1

    invoke-static {p0}, Lt5/d;->e(Ljava/lang/ClassLoader;)Ljava/lang/Class;

    move-result-object v2

    sput-object v2, Lt5/d;->b:Ljava/lang/Class;
    ...
    sget-object v4, Lt5/d;->b:Ljava/lang/Class;
    ...
    const-string p0, "getChatroomInfo: svc null after cache"
    ...
    const-string p0, "getChatroomInfo: inst null"
    ...
    invoke-static {p0, v2, p1}, Lde/robv/android/xposed/XposedHelpers;->callMethod(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v2, "getChatroomInfo err: "
...
.method public static l(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Object;
    .locals 4
...
.method public static m(Ljava/lang/ClassLoader;)Ljava/lang/Object;
    .locals 3
...
.method public static o(Ljava/lang/ClassLoader;Ljava/lang/String;)I
    .locals 2

    .line 1
    invoke-static {p0, p1}, Lt5/d;->j(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Object;
    ...
    :catch_0
    :cond_0
    invoke-static {p0, p1}, Lt5/d;->p(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/util/List;
...
.method public static p(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static q(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/String;
    .locals 1
    ...
    :cond_0
    :try_start_0
    const-string v0, "field_selfDisplayName"
...
.method public static t(Ljava/lang/ClassLoader;Ljava/lang/String;)J
    .locals 2
...
.method public static u(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    ...
    :try_start_0
    const-string p1, "field_displayname"
...
.method public static v(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/String;
    .locals 1
    ...
    :cond_0
    :try_start_0
    const-string v0, "field_chatroomnotice"
...
.method public static w(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/String;
    .locals 1
    ...
    :cond_0
    :try_start_0
    const-string v0, "field_chatroomnoticeEditor"
...
.method public static x(Ljava/lang/ClassLoader;Ljava/lang/String;)J
    .locals 2
    ...
    :cond_0
    :try_start_0
    const-string p1, "field_chatroomnoticePublishTime"
...
.method public static y(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    ...
    :try_start_0
    const-string p1, "field_roomowner"
...
.method public static z(Ljava/lang/ClassLoader;Ljava/lang/String;)I
    .locals 1
    ...
    :cond_0
    :try_start_0
    const-string v0, "field_chatroomStatus"
