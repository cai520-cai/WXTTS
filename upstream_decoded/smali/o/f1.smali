...
.method public constructor <init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    iput-object p1, p0, Lo/f1;->a:Landroid/content/Context;

    iput-object p2, p0, Lo/f1;->b:Landroid/content/res/TypedArray;

    return-void
.end method

.method public static E(Landroid/content/Context;I[I)Lo/f1;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lo/f1;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    return-object v0
.end method

.method public static F(Landroid/content/Context;Landroid/util/AttributeSet;[I)Lo/f1;
    .locals 1
...
.method public static G(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lo/f1;
    .locals 1
...
.method public A(ILandroid/util/TypedValue;)Z
    ...
    .line 1
    iget-object v0, p0, Lo/f1;->b:Landroid/content/res/TypedArray;
...
.method public b()I
    ...
    invoke-static {v0}, Lo/f1$a;->a(Landroid/content/res/TypedArray;)I
...
.method public d(I)Landroid/content/res/ColorStateList;
    ...
    iget-object v1, p0, Lo/f1;->a:Landroid/content/Context;
...
.method public h(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p0, Lo/f1;->a:Landroid/content/Context;
...
.method public i(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v1, p1, v2}, Lo/j;->d(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
...
.method public k(IILq0/i$g;)Landroid/graphics/Typeface;
    .locals 2
    .param p1    # I
    ...
    :cond_0
    iget-object v0, p0, Lo/f1;->c:Landroid/util/TypedValue;
    ...
    iput-object v0, p0, Lo/f1;->c:Landroid/util/TypedValue;

    :cond_1
    iget-object v0, p0, Lo/f1;->a:Landroid/content/Context;

    iget-object v1, p0, Lo/f1;->c:Landroid/util/TypedValue;

    invoke-static {v0, p1, v1, p2, p3}, Lq0/i;->k(Landroid/content/Context;ILandroid/util/TypedValue;ILq0/i$g;)Landroid/graphics/Typeface;
...
.method public z(I)I
    ...
    invoke-static {v0, p1}, Lo/f1$a;->b(Landroid/content/res/TypedArray;I)I
