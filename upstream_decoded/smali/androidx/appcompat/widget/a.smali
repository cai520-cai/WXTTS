...
# static fields
.field public static final L:Ljava/lang/String; = "ActionMenuPresenter"
...
.field public F:Landroidx/appcompat/widget/a$e;

.field public G:Landroidx/appcompat/widget/a$a;

.field public H:Landroidx/appcompat/widget/a$c;

.field public I:Landroidx/appcompat/widget/a$b;

.field public final J:Landroidx/appcompat/widget/a$f;

.field public K:I

.field public r:Landroidx/appcompat/widget/a$d;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/a;->E:Landroid/util/SparseBooleanArray;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/a;->J:Landroidx/appcompat/widget/a$f;

    return-void
.end method

.method public static synthetic A(Landroidx/appcompat/widget/a;)Landroidx/appcompat/view/menu/k;
    .locals 0

    .line 1
    iget-object p0, p0, Landroidx/appcompat/view/menu/a;->p:Landroidx/appcompat/view/menu/k;
...
.method public static synthetic u(Landroidx/appcompat/widget/a;)Landroidx/appcompat/view/menu/e;
    ...
    .line 1
    iget-object p0, p0, Landroidx/appcompat/view/menu/a;->j:Landroidx/appcompat/view/menu/e;
...
.method public static synthetic w(Landroidx/appcompat/widget/a;)Landroidx/appcompat/view/menu/k;
    .locals 0
...
.method public static synthetic z(Landroidx/appcompat/widget/a;)Landroidx/appcompat/view/menu/e;
    .locals 0
...
.method public final C(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/view/menu/a;->p:Landroidx/appcompat/view/menu/k;
    ...
    invoke-interface {v5}, Landroidx/appcompat/view/menu/k$a;->getItemData()Landroidx/appcompat/view/menu/h;
...
.method public D()Landroid/graphics/drawable/Drawable;
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/a;->r:Landroidx/appcompat/widget/a$d;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/a;->s:Landroid/graphics/drawable/Drawable;
...
.method public E()Z
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/a;->H:Landroidx/appcompat/widget/a$c;

    const/4 v1, 0x1

    if-eqz v0, :cond_0

    iget-object v2, p0, Landroidx/appcompat/view/menu/a;->p:Landroidx/appcompat/view/menu/k;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/a;->H:Landroidx/appcompat/widget/a$c;

    return v1

    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/a;->F:Landroidx/appcompat/widget/a$e;
...
.method public F()Z
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/a;->G:Landroidx/appcompat/widget/a$a;
...
.method public J(Landroid/content/res/Configuration;)V
    ...
    .line 1
    iget-boolean p1, p0, Landroidx/appcompat/widget/a;->z:Z
    ...
    iput p1, p0, Landroidx/appcompat/widget/a;->y:I

    :cond_0
    iget-object p1, p0, Landroidx/appcompat/view/menu/a;->j:Landroidx/appcompat/view/menu/e;
...
.method public L(I)V
    ...
    iput-boolean p1, p0, Landroidx/appcompat/widget/a;->z:Z
...
.method public M(Landroidx/appcompat/widget/ActionMenuView;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/appcompat/view/menu/a;->p:Landroidx/appcompat/view/menu/k;

    iget-object v0, p0, Landroidx/appcompat/view/menu/a;->j:Landroidx/appcompat/view/menu/e;

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/ActionMenuView;->c(Landroidx/appcompat/view/menu/e;)V
...
.method public N(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/a;->s:Landroid/graphics/drawable/Drawable;
...
.method public Q()Z
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/a;->p:Landroidx/appcompat/view/menu/k;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroidx/appcompat/widget/a;->H:Landroidx/appcompat/widget/a$c;

    if-nez v1, :cond_0

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/e;->C()Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/a;->j:Landroidx/appcompat/view/menu/e;

    iget-object v5, p0, Landroidx/appcompat/widget/a;->r:Landroidx/appcompat/widget/a$d;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/a;->H:Landroidx/appcompat/widget/a$c;
...
.method public a(Z)V
    ...
    invoke-super {p0, p1}, Landroidx/appcompat/view/menu/a;->f(Landroidx/appcompat/view/menu/m;)Z
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/view/menu/e;->f(Z)V
...
.method public d(Landroid/content/Context;Landroidx/appcompat/view/menu/e;)V
    ...
    iget-boolean v0, p0, Landroidx/appcompat/widget/a;->v:Z

    if-nez v0, :cond_0

    invoke-virtual {p1}, Lm/a;->h()Z

    move-result v0

    iput-boolean v0, p0, Landroidx/appcompat/widget/a;->u:Z
    ...
    iput v0, p0, Landroidx/appcompat/widget/a;->w:I
    ...
    :cond_2
    iget p1, p0, Landroidx/appcompat/widget/a;->w:I
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/a;->r:Landroidx/appcompat/widget/a$d;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/a;->s:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0, v2}, Lo/q;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    iput-object v1, p0, Landroidx/appcompat/widget/a;->s:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/a;->r:Landroidx/appcompat/widget/a$d;
    ...
    :cond_5
    iput-object v1, p0, Landroidx/appcompat/widget/a;->r:Landroidx/appcompat/widget/a$d;

    :goto_0
    iput p1, p0, Landroidx/appcompat/widget/a;->x:I
...
.method public e(Landroid/os/Parcelable;)V
    ...
    iget p1, p1, Landroidx/appcompat/widget/a$g;->k:I
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/a;->f(Landroidx/appcompat/view/menu/m;)Z
...
.method public f(Landroidx/appcompat/view/menu/m;)Z
    ...
    :goto_0
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/m;->n0()Landroid/view/Menu;

    move-result-object v2

    iget-object v3, p0, Landroidx/appcompat/view/menu/a;->j:Landroidx/appcompat/view/menu/e;
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/a;->C(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    iput v2, p0, Landroidx/appcompat/widget/a;->K:I
    ...
    invoke-direct {v2, p0, v3, p1, v0}, Landroidx/appcompat/widget/a$a;-><init>(Landroidx/appcompat/widget/a;Landroid/content/Context;Landroidx/appcompat/view/menu/m;Landroid/view/View;)V

    iput-object v2, p0, Landroidx/appcompat/widget/a;->G:Landroidx/appcompat/widget/a$a;

    invoke-virtual {v2, v1}, Landroidx/appcompat/view/menu/i;->i(Z)V
...
.method public g(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/a;->p:Landroidx/appcompat/view/menu/k;
    ...
    invoke-virtual {v3}, Landroidx/appcompat/view/menu/h;->b()Ll1/b;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-virtual {v3, p0}, Ll1/b;->k(Ll1/b$a;)V
    ...
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/e;->C()Ljava/util/ArrayList;
    ...
    :goto_1
    iget-boolean v1, p0, Landroidx/appcompat/widget/a;->u:Z
    ...
    :goto_2
    iget-object p1, p0, Landroidx/appcompat/widget/a;->r:Landroidx/appcompat/widget/a$d;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/a;->r:Landroidx/appcompat/widget/a$d;
...
.method public h(Landroidx/appcompat/view/menu/h;Landroidx/appcompat/view/menu/k$a;)V
    .locals 1

    .line 1
    const/4 v0, 0x0

    invoke-interface {p2, p1, v0}, Landroidx/appcompat/view/menu/k$a;->g(Landroidx/appcompat/view/menu/h;I)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/a;->I:Landroidx/appcompat/widget/a$b;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/a;->I:Landroidx/appcompat/widget/a$b;
...
.method public i(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/k;
    ...
    invoke-super {p0, p1}, Landroidx/appcompat/view/menu/a;->i(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/k;
...
.method public j()Z
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/a;->j:Landroidx/appcompat/view/menu/e;
    ...
    invoke-virtual {v1}, Landroidx/appcompat/view/menu/e;->H()Ljava/util/ArrayList;
    ...
    :goto_0
    iget v5, v0, Landroidx/appcompat/widget/a;->y:I

    iget v6, v0, Landroidx/appcompat/widget/a;->x:I

    invoke-static {v3, v3}, Landroid/view/View$MeasureSpec;->makeMeasureSpec(II)I

    move-result v7

    iget-object v8, v0, Landroidx/appcompat/view/menu/a;->p:Landroidx/appcompat/view/menu/k;
    ...
    invoke-virtual {v14}, Landroidx/appcompat/view/menu/h;->d()Z
    ...
    :goto_2
    iget-boolean v13, v0, Landroidx/appcompat/widget/a;->C:Z
    ...
    :cond_4
    iget-boolean v9, v0, Landroidx/appcompat/widget/a;->u:Z
    ...
    iget-object v9, v0, Landroidx/appcompat/widget/a;->E:Landroid/util/SparseBooleanArray;

    invoke-virtual {v9}, Landroid/util/SparseBooleanArray;->clear()V

    iget-boolean v10, v0, Landroidx/appcompat/widget/a;->A:Z

    if-eqz v10, :cond_7

    iget v10, v0, Landroidx/appcompat/widget/a;->D:I
    ...
    invoke-virtual {v15}, Landroidx/appcompat/view/menu/h;->d()Z

    move-result v16

    if-eqz v16, :cond_b

    invoke-virtual {v0, v15, v2, v8}, Landroidx/appcompat/widget/a;->r(Landroidx/appcompat/view/menu/h;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v13

    iget-boolean v2, v0, Landroidx/appcompat/widget/a;->A:Z
    ...
    iget-boolean v3, v0, Landroidx/appcompat/widget/a;->A:Z
    ...
    invoke-virtual {v0, v15, v3, v8}, Landroidx/appcompat/widget/a;->r(Landroidx/appcompat/view/menu/h;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_11
    iget-boolean v4, v0, Landroidx/appcompat/widget/a;->A:Z
...
.method public k()Landroid/os/Parcelable;
    ...
    iput v1, v0, Landroidx/appcompat/widget/a$g;->k:I
...
.method public r(Landroidx/appcompat/view/menu/h;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_0
    invoke-super {p0, p1, p2, p3}, Landroidx/appcompat/view/menu/a;->r(Landroidx/appcompat/view/menu/h;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
