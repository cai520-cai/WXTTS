...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroidx/appcompat/view/menu/b$e;
    }
.end annotation
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/b;->s:Lo/s0;
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/b;->G()I
...
.method public final C()Lo/t0;
    ...
    invoke-direct {v0, v1, v4, v2, v3}, Lo/t0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->s:Lo/s0;

    invoke-virtual {v0, v1}, Lo/t0;->r0(Lo/s0;)V
    ...
    invoke-virtual {v0, v1}, Lo/r0;->S(Landroid/view/View;)V

    iget v1, p0, Landroidx/appcompat/view/menu/b;->u:I

    invoke-virtual {v0, v1}, Lo/r0;->W(I)V
    ...
    invoke-virtual {v0, v1}, Lo/r0;->a0(I)V

    return-object v0
.end method

.method public final D(Landroidx/appcompat/view/menu/e;)I
    .locals 3
...
.method public final E(Landroidx/appcompat/view/menu/e;Landroidx/appcompat/view/menu/e;)Landroid/view/MenuItem;
    .locals 4
    .param p1    # Landroidx/appcompat/view/menu/e;
        .annotation build Le/m0;
        .end annotation
...
.method public final F(Landroidx/appcompat/view/menu/b$d;Landroidx/appcompat/view/menu/e;)Landroid/view/View;
    .locals 7
    ...
    invoke-virtual {p0, v0, p2}, Landroidx/appcompat/view/menu/b;->E(Landroidx/appcompat/view/menu/e;Landroidx/appcompat/view/menu/e;)Landroid/view/MenuItem;
    ...
    invoke-virtual {v1, v3}, Landroidx/appcompat/view/menu/d;->d(I)Landroidx/appcompat/view/menu/h;
...
.method public final I(Landroidx/appcompat/view/menu/e;)V
    ...
    invoke-virtual {v1, v2}, Landroidx/appcompat/view/menu/d;->e(Z)V
    ...
    invoke-static {v1, v5, v2, v4}, Ln/d;->r(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I

    move-result v2

    invoke-virtual {p0}, Landroidx/appcompat/view/menu/b;->C()Lo/t0;

    move-result-object v4

    invoke-virtual {v4, v1}, Lo/r0;->q(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Lo/r0;->U(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/b;->u:I

    invoke-virtual {v4, v1}, Lo/r0;->W(I)V
    ...
    invoke-virtual {p0, v1, p1}, Landroidx/appcompat/view/menu/b;->F(Landroidx/appcompat/view/menu/b$d;Landroidx/appcompat/view/menu/e;)Landroid/view/View;
    ...
    invoke-virtual {v4, v7}, Lo/t0;->s0(Z)V

    invoke-virtual {v4, v5}, Lo/t0;->p0(Ljava/lang/Object;)V

    invoke-virtual {p0, v2}, Landroidx/appcompat/view/menu/b;->H(I)I
    ...
    invoke-virtual {v4, v6}, Lo/r0;->S(Landroid/view/View;)V
    ...
    :goto_5
    invoke-virtual {v4, v12}, Lo/r0;->l(I)V

    invoke-virtual {v4, v3}, Lo/r0;->h0(Z)V

    invoke-virtual {v4, v8}, Lo/r0;->j(I)V
    ...
    invoke-virtual {v4, v2}, Lo/r0;->l(I)V
    ...
    invoke-virtual {v4, v2}, Lo/r0;->j(I)V
    ...
    invoke-virtual {v4, v2}, Lo/r0;->X(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/b$d;-><init>(Lo/t0;Landroidx/appcompat/view/menu/e;I)V

    iget-object v3, p0, Landroidx/appcompat/view/menu/b;->p:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Lo/r0;->a()V

    invoke-virtual {v4}, Lo/r0;->h()Landroid/widget/ListView;
    ...
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/e;->A()Ljava/lang/CharSequence;
...
.method public a()V
    ...
    invoke-virtual {p0, v1}, Landroidx/appcompat/view/menu/b;->I(Landroidx/appcompat/view/menu/e;)V
...
.method public b(Landroidx/appcompat/view/menu/e;Z)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/b;->D(Landroidx/appcompat/view/menu/e;)I
    ...
    invoke-virtual {v1, v3}, Landroidx/appcompat/view/menu/e;->f(Z)V
    ...
    invoke-virtual {v1, p0}, Landroidx/appcompat/view/menu/e;->S(Landroidx/appcompat/view/menu/j;)V
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Lo/t0;

    invoke-virtual {v1, v2}, Lo/t0;->q0(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Lo/t0;

    invoke-virtual {v1, v3}, Lo/r0;->T(I)V

    :cond_2
    iget-object v0, v0, Landroidx/appcompat/view/menu/b$d;->a:Lo/t0;
    ...
    iget-object p2, p0, Landroidx/appcompat/view/menu/b;->E:Landroidx/appcompat/view/menu/j$a;
    ...
    invoke-virtual {p1, v3}, Landroidx/appcompat/view/menu/e;->f(Z)V
...
.method public dismiss()V
    ...
    iget-object v3, v2, Landroidx/appcompat/view/menu/b$d;->a:Lo/t0;

    invoke-virtual {v3}, Lo/r0;->c()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroidx/appcompat/view/menu/b$d;->a:Lo/t0;

    invoke-virtual {v2}, Lo/r0;->dismiss()V
...
.method public f(Landroidx/appcompat/view/menu/m;)Z
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/b;->o(Landroidx/appcompat/view/menu/e;)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->E:Landroidx/appcompat/view/menu/j$a;
...
.method public g(Z)V
    ...
    invoke-static {v0}, Ln/d;->B(Landroid/widget/ListAdapter;)Landroidx/appcompat/view/menu/d;
...
.method public n(Landroidx/appcompat/view/menu/j$a;)V
    ...
    .line 1
    iput-object p1, p0, Landroidx/appcompat/view/menu/b;->E:Landroidx/appcompat/view/menu/j$a;
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroidx/appcompat/view/menu/b$d;->a:Lo/t0;

    invoke-virtual {v4}, Lo/r0;->c()Z
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/e;->f(Z)V
