...
# static fields
.field public static final B:Ljava/lang/String; = "CoordinatorLayout"
...
.field public static final L:Lk1/u$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lk1/u$a<",
...
.field public t:Landroidx/coordinatorlayout/widget/CoordinatorLayout$h;

.field public u:Z

.field public v:Ll1/x2;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$j;-><init>()V
    ...
    sput-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->L:Lk1/u$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Li0/b;
    ...
    invoke-direct {v0, p0}, Ll1/y0;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A:Ll1/y0;

    const/4 v0, 0x0

    sget-object v1, Lh0/a$j;->g:[I
    ...
    invoke-static/range {v2 .. v8}, Li0/a;->a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V
    ...
    invoke-direct {p1, p0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;-><init>(Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V
...
.method public static P(Landroid/content/Context;Landroid/util/AttributeSet;Ljava/lang/String;)Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;
    ...
    :goto_0
    :try_start_0
    sget-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->G:Ljava/lang/ThreadLocal;
    ...
    sget-object v2, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->F:[Ljava/lang/Class;
...
.method public static T(Landroid/graphics/Rect;)V
    ...
    sget-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->L:Lk1/u$a;
...
# virtual methods
.method public final A(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;II)V
    .locals 5

    .line 1
    iget p1, p5, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->c:I
    ...
    iget p5, p5, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->d:I

    invoke-static {p5}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->X(I)I

    move-result p5

    invoke-static {p5, p2}, Ll1/c0;->d(II)I
...
.method public C(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->h()Landroid/graphics/Rect;
...
.method public D(Landroid/view/View;)Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;
    .locals 6
    ...
    :cond_0
    invoke-virtual {v0, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->q(Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;)V

    :cond_1
    :goto_0
    iput-boolean v2, v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->b:Z
...
.method public final E(Ljava/util/List;)V
    ...
    :cond_1
    sget-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->K:Ljava/util/Comparator;
...
.method public final F(Landroid/view/View;)Z
    ...
    .line 1
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Li0/b;

    invoke-virtual {v0, p1}, Li0/b;->j(Ljava/lang/Object;)Z
...
.method public final H(Landroid/view/View;I)V
    ...
    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->v:Ll1/x2;
    ...
    iget-object v2, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->v:Ll1/x2;

    invoke-virtual {v2}, Ll1/x2;->p()I
    ...
    invoke-static/range {v1 .. v6}, Ll1/c0;->b(IIILandroid/graphics/Rect;Landroid/graphics/Rect;I)V
...
.method public final J(Landroid/view/View;II)V
    ...
    iget v1, v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->c:I

    invoke-static {v1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->Y(I)I

    move-result v1

    invoke-static {v1, p3}, Ll1/c0;->d(II)I
...
.method public final K(Landroid/view/View;Landroid/graphics/Rect;I)V
    ...
    invoke-virtual {v1, p0, p1, v2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->i(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/graphics/Rect;)Z
    ...
    :cond_4
    iget v1, v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->h:I
    ...
    iget v4, v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->j:I
    ...
    iget v6, v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->j:I
    ...
    iget v4, v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->i:I
    ...
    iget v0, v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->i:I
...
.method public L(Landroid/view/View;I)V
    ...
    check-cast v10, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;

    iget-object v0, v10, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->k:Landroid/view/View;
    ...
    invoke-virtual/range {v0 .. v7}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;II)V
    ...
    :goto_2
    invoke-virtual {v8, v10, v13, v15, v0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->k(Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;Landroid/graphics/Rect;II)V
    ...
    invoke-static {v9, v0}, Ll1/j1;->e1(Landroid/view/View;I)V

    :cond_2
    if-eqz v1, :cond_3

    invoke-static {v9, v1}, Ll1/j1;->f1(Landroid/view/View;I)V

    :cond_3
    if-eqz v14, :cond_4

    invoke-virtual {v10}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->f()Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;

    move-result-object v0

    if-eqz v0, :cond_4

    iget-object v1, v10, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->k:Landroid/view/View;

    invoke-virtual {v0, v8, v9, v1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->p(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
...
.method public final M(I)V
    ...
    iget-object v13, v10, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->l:Landroid/view/View;
    ...
    iget v12, v10, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->g:I
    ...
    invoke-static {v12, v2}, Ll1/c0;->d(II)I
    ...
    :cond_7
    :goto_3
    iget v10, v10, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->h:I
    ...
    check-cast v14, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;

    invoke-virtual {v14}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->f()Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;

    move-result-object v15

    if-eqz v15, :cond_d

    invoke-virtual {v15, v0, v13, v9}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->m(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-virtual {v14}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->g()Z

    move-result v16

    if-eqz v16, :cond_b

    invoke-virtual {v14}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->l()V
    ...
    invoke-virtual {v15, v0, v13, v9}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->p(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    :cond_c
    invoke-virtual {v15, v0, v13, v9}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->q(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-virtual {v14, v13}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->r(Z)V
...
.method public N(Landroid/view/View;I)V
    ...
    invoke-virtual {v0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->a()Z
...
.method public final Q(Landroid/view/MotionEvent;I)Z
    ...
    invoke-virtual {v12}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->f()Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;
    ...
    :cond_2
    invoke-virtual {v13, v0, v11, v7}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->L(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z

    goto :goto_3

    :cond_3
    invoke-virtual {v13, v0, v11, v7}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->s(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_5
    invoke-virtual {v13, v0, v11, v1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->L(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_6
    invoke-virtual {v13, v0, v11, v1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->s(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_7
    invoke-virtual {v12}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->c()Z

    move-result v10

    invoke-virtual {v12, v0, v11}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->j(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;)Z
...
.method public final R()V
    ...
    invoke-virtual {p0, v3}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->D(Landroid/view/View;)Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;

    move-result-object v4

    invoke-virtual {v4, p0, v3}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->d(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;)Landroid/view/View;

    iget-object v5, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Li0/b;

    invoke-virtual {v5, v3}, Li0/b;->b(Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, p0, v3, v6}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->b(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z

    move-result v7

    if-eqz v7, :cond_2

    iget-object v7, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Li0/b;

    invoke-virtual {v7, v6}, Li0/b;->d(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v7, v6}, Li0/b;->b(Ljava/lang/Object;)V

    :cond_1
    iget-object v7, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Li0/b;

    invoke-virtual {v7, v6, v3}, Li0/b;->a(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Li0/b;

    invoke-virtual {v1}, Li0/b;->i()Ljava/util/ArrayList;
...
.method public S(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p1, p2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->s(Landroid/graphics/Rect;)V
...
.method public U()V
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->t:Landroidx/coordinatorlayout/widget/CoordinatorLayout$h;
    ...
    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->t:Landroidx/coordinatorlayout/widget/CoordinatorLayout$h;
...
.method public final V(Z)V
    ...
    invoke-virtual {v4}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->f()Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;
    ...
    invoke-virtual {v4, p0, v3, v5}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->s(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->n()V
...
.method public final Z(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, Ll1/j1;->e1(Landroid/view/View;I)V

    iput p2, v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->i:I
...
.method public final a0(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, Ll1/j1;->f1(Landroid/view/View;I)V

    iput p2, v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->j:I

    :cond_0
    return-void
.end method

.method public final b0(Ll1/x2;)Ll1/x2;
    .locals 3

    .line 1
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->v:Ll1/x2;
    ...
    iput-object p1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->v:Ll1/x2;
    ...
    invoke-virtual {p0, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->l(Ll1/x2;)Ll1/x2;
...
.method public final c0()V
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:Ll1/z0;
    ...
    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:Ll1/z0;
...
.method public d(Landroid/view/View;Landroid/view/View;II)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A:Ll1/y0;

    invoke-virtual {v0, p1, p2, p3, p4}, Ll1/y0;->c(Landroid/view/View;Landroid/view/View;II)V
    ...
    invoke-virtual {v2, p4}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->k(I)Z
    ...
    invoke-virtual/range {v2 .. v8}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->D(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;Landroid/view/View;II)V
...
.method public drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v1, v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->a:Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;

    if-eqz v1, :cond_2

    invoke-virtual {v1, p0, p2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->k(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;)F
    ...
    invoke-virtual {v0, p0, p2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->j(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;)I
    ...
    invoke-static {v1, v2, v3}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->j(III)I
...
.method public e(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2}, Ll1/y0;->e(Landroid/view/View;I)V
    ...
    invoke-virtual {v3, p2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->k(I)Z
    ...
    :cond_0
    invoke-virtual {v3}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->f()Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;

    move-result-object v4

    if-eqz v4, :cond_1

    invoke-virtual {v4, p0, v2, p1, p2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->K(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;I)V

    :cond_1
    invoke-virtual {v3, p2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->m(I)V

    invoke-virtual {v3}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->l()V
...
.method public g(Landroid/view/View;II[II)V
    ...
    invoke-virtual {v1, v15}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->k(I)Z
    ...
    invoke-virtual/range {v0 .. v7}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->y(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;II[II)V
...
.method public bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->p()Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->q(Landroid/util/AttributeSet;)Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;
...
.method public bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 2
    invoke-virtual {p0, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->u(Landroid/view/ViewGroup$LayoutParams;)Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;
...
.method public final getLastWindowInsets()Ll1/x2;
    .locals 1
...
.method public i()V
    ...
    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->t:Landroidx/coordinatorlayout/widget/CoordinatorLayout$h;
...
.method public final k(Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;Landroid/graphics/Rect;II)V
    .locals 5
...
.method public final l(Ll1/x2;)Ll1/x2;
    .locals 4

    .line 1
    invoke-virtual {p1}, Ll1/x2;->A()Z
    ...
    invoke-static {v2}, Ll1/j1;->U(Landroid/view/View;)Z
    ...
    invoke-virtual {v3, p0, v2, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->n(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Ll1/x2;)Ll1/x2;
...
.method public m(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Li0/b;->g(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-virtual {v3, p0, v2, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->p(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
...
.method public n(Landroid/view/View;Landroid/view/View;)Z
    .locals 4
    .param p1    # Landroid/view/View;
        .annotation build Le/m0;
        .end annotation
    ...
    :goto_0
    invoke-virtual {p0, p1, v2, v0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->v(Landroid/view/View;ZLandroid/graphics/Rect;)V
    ...
    :goto_1
    invoke-virtual {p0, p2, v2, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->v(Landroid/view/View;ZLandroid/graphics/Rect;)V
...
.method public onDetachedFromWindow()V
    ...
    iget-object v2, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->t:Landroidx/coordinatorlayout/widget/CoordinatorLayout$h;
...
.method public onLayout(ZIIII)V
    ...
    invoke-virtual {p5}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->f()Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;

    move-result-object p5

    if-eqz p5, :cond_1

    invoke-virtual {p5, p0, p4, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->t(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
...
.method public onMeasure(II)V
    ...
    iget-object v3, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->v:Ll1/x2;
    ...
    iget v0, v1, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->e:I
    ...
    iget v11, v1, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->c:I

    invoke-static {v11}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->Y(I)I

    move-result v11

    invoke-static {v11, v10}, Ll1/c0;->d(II)I
    ...
    invoke-static/range {v20 .. v20}, Ll1/j1;->U(Landroid/view/View;)Z

    move-result v0

    if-nez v0, :cond_a

    iget-object v0, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->v:Ll1/x2;

    invoke-virtual {v0}, Ll1/x2;->p()I

    move-result v0

    iget-object v2, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->v:Ll1/x2;
    ...
    iget-object v11, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->v:Ll1/x2;

    invoke-virtual {v11}, Ll1/x2;->o()I
    ...
    invoke-virtual/range {v0 .. v6}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->u(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;IIII)Z
...
.method public onNestedFling(Landroid/view/View;FFZ)Z
    ...
    invoke-virtual {v4, v1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->k(I)Z
    ...
    invoke-virtual/range {v4 .. v10}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->v(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;FFZ)Z
...
.method public onNestedPreFling(Landroid/view/View;FF)Z
    ...
    invoke-virtual/range {v4 .. v9}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->w(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;FF)Z
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    instance-of v0, p1, Landroidx/coordinatorlayout/widget/CoordinatorLayout$i;
    ...
    :cond_0
    check-cast p1, Landroidx/coordinatorlayout/widget/CoordinatorLayout$i;
    ...
    iget-object p1, p1, Landroidx/coordinatorlayout/widget/CoordinatorLayout$i;->m:Landroid/util/SparseArray;
    ...
    invoke-virtual {p0, v2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->D(Landroid/view/View;)Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;
    ...
    invoke-virtual {v4, p0, v2, v3}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->F(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/os/Parcelable;)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v0, v1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$i;-><init>(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v6}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->f()Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;
    ...
    invoke-virtual {v6, p0, v4}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->G(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;)Landroid/os/Parcelable;
    ...
    :cond_1
    iput-object v1, v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout$i;->m:Landroid/util/SparseArray;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v6, v0, v7, v1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->L(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public p()Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;
    .locals 2
    ...
    invoke-direct {v0, v1, v1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;-><init>(II)V

    return-object v0
.end method

.method public q(Landroid/util/AttributeSet;)Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;
    .locals 2
...
.method public r(Landroid/view/View;IIIII[I)V
    ...
    invoke-virtual {v1, v8}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->k(I)Z
    ...
    invoke-virtual/range {v0 .. v9}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->B(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;IIIII[I)V
...
.method public requestChildRectangleOnScreen(Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    invoke-virtual {v0, p0, p1, p2, p3}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->E(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/graphics/Rect;Z)Z
...
.method public s(Landroid/view/View;IIIII)V
    ...
    invoke-virtual/range {v0 .. v7}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->r(Landroid/view/View;IIIII[I)V
...
.method public t(Landroid/view/View;Landroid/view/View;II)Z
    ...
    invoke-virtual {v13}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->f()Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;
    ...
    invoke-virtual/range {v0 .. v6}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->I(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;Landroid/view/View;II)Z

    move-result v0

    or-int/2addr v11, v0

    invoke-virtual {v13, v7, v0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->t(IZ)V

    goto :goto_1

    :cond_1
    invoke-virtual {v13, v7, v9}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;->t(IZ)V
...
.method public u(Landroid/view/ViewGroup$LayoutParams;)Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;
    .locals 1
...
.method public w(Landroid/view/View;)Ljava/util/List;
    ...
    invoke-virtual {v0, p1}, Li0/b;->h(Ljava/lang/Object;)Ljava/util/List;
...
.method public y(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Li0/c;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method public z(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v1 .. v8}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->A(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;II)V

    invoke-virtual {p0, v0, p4, v9, v10}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->k(Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;Landroid/graphics/Rect;II)V
