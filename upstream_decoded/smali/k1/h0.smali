...
.method public static final d(Landroid/util/SparseBooleanArray;Ls6/p;)V
    .locals 4
    .param p0    # Landroid/util/SparseBooleanArray;
        .annotation build Lr7/d;
        .end annotation
...
.method public static final f(Landroid/util/SparseBooleanArray;ILs6/a;)Z
    .locals 1
    .param p0    # Landroid/util/SparseBooleanArray;
        .annotation build Lr7/d;
        .end annotation
...
.method public static final j(Landroid/util/SparseBooleanArray;)Lw5/s0;
    .locals 1
    .param p0    # Landroid/util/SparseBooleanArray;
        .annotation build Lr7/d;
        .end annotation
    ...
    new-instance v0, Lk1/h0$a;

    invoke-direct {v0, p0}, Lk1/h0$a;-><init>(Landroid/util/SparseBooleanArray;)V
...
.method public static final k(Landroid/util/SparseBooleanArray;Landroid/util/SparseBooleanArray;)Landroid/util/SparseBooleanArray;
    ...
    invoke-static {v0, p0}, Lk1/h0;->l(Landroid/util/SparseBooleanArray;Landroid/util/SparseBooleanArray;)V

    invoke-static {v0, p1}, Lk1/h0;->l(Landroid/util/SparseBooleanArray;Landroid/util/SparseBooleanArray;)V
...
.method public static final o(Landroid/util/SparseBooleanArray;)Lw5/r;
    .locals 1
    .param p0    # Landroid/util/SparseBooleanArray;
        .annotation build Lr7/d;
        .end annotation
    ...
    new-instance v0, Lk1/h0$b;

    invoke-direct {v0, p0}, Lk1/h0$b;-><init>(Landroid/util/SparseBooleanArray;)V
