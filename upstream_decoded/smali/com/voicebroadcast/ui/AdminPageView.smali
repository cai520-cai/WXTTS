.class public Lcom/voicebroadcast/ui/AdminPageView;
...
.method public static synthetic a(Landroid/widget/EditText;Landroid/content/Context;FLandroid/widget/LinearLayout;Landroid/view/View;)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3, p4}, Lcom/voicebroadcast/ui/AdminPageView;->lambda$buildBlacklistCard$0(Landroid/widget/EditText;Landroid/content/Context;FLandroid/widget/LinearLayout;Landroid/view/View;)V
...
.method public static synthetic b(Ljava/lang/String;Landroid/content/Context;FLandroid/widget/LinearLayout;Landroid/view/View;)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3, p4}, Lcom/voicebroadcast/ui/AdminPageView;->lambda$refreshBlacklistList$1(Ljava/lang/String;Landroid/content/Context;FLandroid/widget/LinearLayout;Landroid/view/View;)V
...
.method private static buildBlacklistCard(Landroid/content/Context;F)Landroid/view/View;
    ...
    invoke-static {p0, p1}, Lcom/voicebroadcast/ui/AdminPageView;->makeCard(Landroid/content/Context;F)Landroid/widget/LinearLayout;
    ...
    invoke-static {p0, p1, v1}, Lcom/voicebroadcast/ui/AdminPageView;->refreshBlacklistList(Landroid/content/Context;FLandroid/widget/LinearLayout;)V
    ...
    new-instance v4, Lcom/voicebroadcast/ui/b;

    invoke-direct {v4, v6, p0, p1, v1}, Lcom/voicebroadcast/ui/b;-><init>(Landroid/widget/EditText;Landroid/content/Context;FLandroid/widget/LinearLayout;)V
...
.method public static create(Landroid/content/Context;Landroid/app/Activity;)Landroid/view/View;
    ...
    invoke-static {p0, p1, v1}, Lcom/voicebroadcast/ui/AdminPageView;->sectionLabel(Landroid/content/Context;FLjava/lang/String;)Landroid/widget/TextView;

    move-result-object v1

    invoke-virtual {v2, v1}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    invoke-static {p0, p1}, Lcom/voicebroadcast/ui/AdminPageView;->buildBlacklistCard(Landroid/content/Context;F)Landroid/view/View;
...
.method private static synthetic lambda$buildBlacklistCard$0(Landroid/widget/EditText;Landroid/content/Context;FLandroid/widget/LinearLayout;Landroid/view/View;)V
    ...
    invoke-static {p1, p0}, Lcom/voicebroadcast/ui/AdminPageView;->toast(Landroid/content/Context;Ljava/lang/String;)V

    return-void

    :cond_0
    invoke-static {p4}, Lcom/voicebroadcast/service/ActivationManager;->isAdmin(Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-static {p4}, Lcom/voicebroadcast/service/ActivationManager;->addBlacklist(Ljava/lang/String;)V
    ...
    invoke-static {p1, p2, p3}, Lcom/voicebroadcast/ui/AdminPageView;->refreshBlacklistList(Landroid/content/Context;FLandroid/widget/LinearLayout;)V
...
.method private static synthetic lambda$refreshBlacklistList$1(Ljava/lang/String;Landroid/content/Context;FLandroid/widget/LinearLayout;Landroid/view/View;)V
    ...
    invoke-static {p0}, Lcom/voicebroadcast/service/ActivationManager;->removeBlacklist(Ljava/lang/String;)V
...
.method private static refreshBlacklistList(Landroid/content/Context;FLandroid/widget/LinearLayout;)V
    ...
    invoke-static {}, Lcom/voicebroadcast/service/ActivationManager;->getBlacklist()Ljava/util/Set;
    ...
    invoke-static {p0, p1}, Lcom/voicebroadcast/ui/AdminPageView;->candyDivider(Landroid/content/Context;F)Landroid/view/View;
    ...
    new-instance v9, Lcom/voicebroadcast/ui/a;

    invoke-direct {v9, v6, p0, p1, p2}, Lcom/voicebroadcast/ui/a;-><init>(Ljava/lang/String;Landroid/content/Context;FLandroid/widget/LinearLayout;)V
