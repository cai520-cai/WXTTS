.class public Lcom/voicebroadcast/hook/ChatGroupMenuHook;
...
.method public static bridge synthetic a(Ljava/lang/String;)V
    ...
    .line 1
    invoke-static {p0}, Lcom/voicebroadcast/hook/ChatGroupMenuHook;->log(Ljava/lang/String;)V
...
.method public static bridge synthetic b(Landroid/app/Activity;)V
    ...
    .line 1
    invoke-static {p0}, Lcom/voicebroadcast/hook/ChatGroupMenuHook;->showCreateFirstLabelDialog(Landroid/app/Activity;)V
...
.method public static bridge synthetic c(Landroid/app/Activity;)V
    ...
    .line 1
    invoke-static {p0}, Lcom/voicebroadcast/hook/ChatGroupMenuHook;->showGroupMenuDialog(Landroid/app/Activity;)V
...
.method public static bridge synthetic d(Landroid/app/Activity;Ljava/util/List;)V
    ...
    .line 1
    invoke-static {p0, p1}, Lcom/voicebroadcast/hook/ChatGroupMenuHook;->showQuickViewLabelsDialog(Landroid/app/Activity;Ljava/util/List;)V
...
.method public static hook(Ljava/lang/ClassLoader;)V
    ...
    invoke-static {v0}, Lcom/voicebroadcast/hook/ChatGroupMenuHook;->log(Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lcom/voicebroadcast/hook/ChatGroupMenuHook;->log(Ljava/lang/String;)V

    const-string v1, "onCreateOptionsMenu"

    new-instance v2, Lcom/voicebroadcast/hook/ChatGroupMenuHook$1;

    invoke-direct {v2}, Lcom/voicebroadcast/hook/ChatGroupMenuHook$1;-><init>()V
    ...
    new-instance v2, Lcom/voicebroadcast/hook/ChatGroupMenuHook$2;

    invoke-direct {v2}, Lcom/voicebroadcast/hook/ChatGroupMenuHook$2;-><init>()V
    ...
    invoke-static {p0}, Lcom/voicebroadcast/hook/ChatGroupMenuHook;->tryFallbackHooks(Ljava/lang/ClassLoader;)V
...
.method private static showCreateFirstLabelDialog(Landroid/app/Activity;)V
    ...
    new-instance v2, Lcom/voicebroadcast/hook/ChatGroupMenuHook$6;

    invoke-direct {v2, v0, p0}, Lcom/voicebroadcast/hook/ChatGroupMenuHook$6;-><init>(Landroid/widget/EditText;Landroid/app/Activity;)V
...
.method private static showGroupMenuDialog(Landroid/app/Activity;)V
    ...
    new-instance v3, Lcom/voicebroadcast/hook/ChatGroupMenuHook$5;

    invoke-direct {v3, v0, p0}, Lcom/voicebroadcast/hook/ChatGroupMenuHook$5;-><init>(Ljava/util/List;Landroid/app/Activity;)V
...
.method private static showQuickViewLabelsDialog(Landroid/app/Activity;Ljava/util/List;)V
    ...
    iget-object v3, v3, Lcom/voicebroadcast/hook/model/LabelInfo;->contacts:Ljava/util/List;
    ...
    new-instance v0, Lcom/voicebroadcast/hook/ChatGroupMenuHook$7;

    invoke-direct {v0, p0}, Lcom/voicebroadcast/hook/ChatGroupMenuHook$7;-><init>(Landroid/app/Activity;)V
...
.method private static tryFallbackHooks(Ljava/lang/ClassLoader;)V
    ...
    new-instance v5, Lcom/voicebroadcast/hook/ChatGroupMenuHook$3;

    invoke-direct {v5, v2}, Lcom/voicebroadcast/hook/ChatGroupMenuHook$3;-><init>(Ljava/lang/String;)V
    ...
    new-instance v5, Lcom/voicebroadcast/hook/ChatGroupMenuHook$4;

    invoke-direct {v5}, Lcom/voicebroadcast/hook/ChatGroupMenuHook$4;-><init>()V
    ...
    invoke-static {v2}, Lcom/voicebroadcast/hook/ChatGroupMenuHook;->log(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
