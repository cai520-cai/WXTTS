...
.method private final buildContentView(Landroid/view/LayoutInflater;)Landroidx/slidingpanelayout/widget/SlidingPaneLayout;
    ...
    .local v1, "$this$buildContentView_u24lambda_u2d4":Landroidx/slidingpanelayout/widget/SlidingPaneLayout;
    const/4 v2, 0x0
    ...
    .line 163
    .end local v1    # "$this$buildContentView_u24lambda_u2d4":Landroidx/slidingpanelayout/widget/SlidingPaneLayout;
    ...
    .local v2, "$this$buildContentView_u24lambda_u2d5":Landroidx/fragment/app/FragmentContainerView;
    const/4 v3, 0x0
    ...
    invoke-virtual {v2, v4}, Landroidx/fragment/app/FragmentContainerView;->setId(I)V

    .line 169
    nop

    .line 167
    .end local v2    # "$this$buildContentView_u24lambda_u2d5":Landroidx/fragment/app/FragmentContainerView;
    .end local v3    # "$i$a$-apply-PreferenceHeaderFragmentCompat$buildContentView$headerContainer$1":I
    nop

    .line 170
    .local v1, "headerContainer":Landroidx/fragment/app/FragmentContainerView;
    ...
    .local v3, "$this$buildContentView_u24lambda_u2d6":Landroidx/slidingpanelayout/widget/SlidingPaneLayout$LayoutParams;
    const/4 v5, 0x0
    ...
    .line 173
    .end local v3    # "$this$buildContentView_u24lambda_u2d6":Landroidx/slidingpanelayout/widget/SlidingPaneLayout$LayoutParams;
    ...
    invoke-direct {v3, v5}, Landroidx/fragment/app/FragmentContainerView;-><init>(Landroid/content/Context;)V

    move-object v5, v3

    .local v5, "$this$buildContentView_u24lambda_u2d7":Landroidx/fragment/app/FragmentContainerView;
    const/4 v6, 0x0
    ...
    invoke-virtual {v5, v7}, Landroidx/fragment/app/FragmentContainerView;->setId(I)V

    .line 184
    nop

    .line 182
    .end local v5    # "$this$buildContentView_u24lambda_u2d7":Landroidx/fragment/app/FragmentContainerView;
    .end local v6    # "$i$a$-apply-PreferenceHeaderFragmentCompat$buildContentView$detailContainer$1":I
    nop

    .line 185
    .local v3, "detailContainer":Landroidx/fragment/app/FragmentContainerView;
    ...
    .local v4, "$this$buildContentView_u24lambda_u2d8":Landroidx/slidingpanelayout/widget/SlidingPaneLayout$LayoutParams;
    const/4 v6, 0x0
    ...
    .line 188
    .end local v4    # "$this$buildContentView_u24lambda_u2d8":Landroidx/slidingpanelayout/widget/SlidingPaneLayout$LayoutParams;
    ...
    .line 191
    .local v4, "detailLayoutParams":Landroidx/slidingpanelayout/widget/SlidingPaneLayout$LayoutParams;
    nop
    ...
    .line 191
    invoke-virtual {v0, v5, v6}, Landroidx/slidingpanelayout/widget/SlidingPaneLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
...
.method private final openPreferenceHeader(Landroidx/preference/Preference;)V
    ...
    .local v1, "$this$openPreferenceHeader_u24lambda_u2d16":Landroidx/fragment/app/Fragment;
    const/4 v2, 0x0
    ...
    .line 285
    .end local v1    # "$this$openPreferenceHeader_u24lambda_u2d16":Landroidx/fragment/app/Fragment;
    ...
    invoke-virtual {v1, v3}, Landroidx/fragment/app/FragmentManager;->getBackStackEntryAt(I)Landroidx/fragment/app/FragmentManager$BackStackEntry;
    ...
    invoke-virtual {v3, v4, v2}, Landroidx/fragment/app/FragmentManager;->popBackStack(II)V
    ...
    .line 368
    .local v1, "$this$commit$iv":Landroidx/fragment/app/FragmentManager;
    const/4 v3, 0x0
    ...
    .line 372
    .local v5, "transaction$iv":Landroidx/fragment/app/FragmentTransaction;
    move-object v6, v5

    .local v6, "$this$openPreferenceHeader_u24lambda_u2d17":Landroidx/fragment/app/FragmentTransaction;
    const/4 v7, 0x0
    ...
    invoke-virtual {v6, v2, v0}, Landroidx/fragment/app/FragmentTransaction;->replace(ILandroidx/fragment/app/Fragment;)Landroidx/fragment/app/FragmentTransaction;
    ...
    invoke-virtual {v6, v2}, Landroidx/fragment/app/FragmentTransaction;->setTransition(I)Landroidx/fragment/app/FragmentTransaction;
    ...
    .line 373
    .end local v6    # "$this$openPreferenceHeader_u24lambda_u2d17":Landroidx/fragment/app/FragmentTransaction;
    ...
    .line 303
    .end local v1    # "$this$commit$iv":Landroidx/fragment/app/FragmentManager;
    .end local v3    # "allowStateLoss$iv":Z
    .end local v4    # "$i$f$commit":I
    .end local v5    # "transaction$iv":Landroidx/fragment/app/FragmentTransaction;
    return-void
.end method
...
.method public onAttach(Landroid/content/Context;)V
    ...
    .local v4, "$this$onAttach_u24lambda_u2d1":Landroidx/fragment/app/FragmentTransaction;
    const/4 v5, 0x0
    ...
    invoke-virtual {v4, v6}, Landroidx/fragment/app/FragmentTransaction;->setPrimaryNavigationFragment(Landroidx/fragment/app/Fragment;)Landroidx/fragment/app/FragmentTransaction;

    .line 136
    nop

    .line 332
    .end local v4    # "$this$onAttach_u24lambda_u2d1":Landroidx/fragment/app/FragmentTransaction;
...
.method public onCreateInitialDetailFragment()Landroidx/fragment/app/Fragment;
    ...
    invoke-virtual {v5, v4}, Landroidx/preference/PreferenceScreen;->getPreference(I)Landroidx/preference/Preference;

    move-result-object v5

    const-string v6, "headerFragment.preferenc\u2026reen.getPreference(index)"

    invoke-static {v5, v6}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    .line 250
    .local v5, "header":Landroidx/preference/Preference;
    invoke-virtual {v5}, Landroidx/preference/Preference;->getFragment()Ljava/lang/String;
    ...
    .line 254
    invoke-virtual {v3, v6, v1}, Landroidx/fragment/app/FragmentFactory;->instantiate(Ljava/lang/ClassLoader;Ljava/lang/String;)Landroidx/fragment/app/Fragment;
    ...
    .local v2, "$this$onCreateInitialDetailFragment_u24lambda_u2d14":Landroidx/fragment/app/Fragment;
    const/4 v3, 0x0

    .line 260
    .local v3, "$i$a$-apply-PreferenceHeaderFragmentCompat$onCreateInitialDetailFragment$1":I
    ...
    .line 259
    .end local v2    # "$this$onCreateInitialDetailFragment_u24lambda_u2d14":Landroidx/fragment/app/Fragment;
    .end local v3    # "$i$a$-apply-PreferenceHeaderFragmentCompat$onCreateInitialDetailFragment$1":I
    nop
    ...
    .end local v5    # "header":Landroidx/preference/Preference;
    :cond_4
    return-object v2

    .line 243
    .end local v0    # "headerFragment":Landroidx/preference/PreferenceFragmentCompat;
    :cond_5
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 150
    .local v1, "existingHeaderFragment":Landroidx/fragment/app/Fragment;
    if-nez v1, :cond_0
    ...
    .line 338
    .local v4, "$this$commit$iv":Landroidx/fragment/app/FragmentManager;
    const/4 v5, 0x0
    ...
    .line 342
    .local v7, "transaction$iv":Landroidx/fragment/app/FragmentTransaction;
    move-object v8, v7

    .local v8, "$this$onCreateView_u24lambda_u2d3_u24lambda_u2d2":Landroidx/fragment/app/FragmentTransaction;
    const/4 v9, 0x0
    ...
    invoke-virtual {v8, v10}, Landroidx/fragment/app/FragmentTransaction;->setReorderingAllowed(Z)Landroidx/fragment/app/FragmentTransaction;
    ...
    invoke-virtual {v8, v10, v11}, Landroidx/fragment/app/FragmentTransaction;->add(ILandroidx/fragment/app/Fragment;)Landroidx/fragment/app/FragmentTransaction;

    .line 155
    nop

    .line 343
    .end local v8    # "$this$onCreateView_u24lambda_u2d3_u24lambda_u2d2":Landroidx/fragment/app/FragmentTransaction;
    ...
    .line 156
    .end local v4    # "$this$commit$iv":Landroidx/fragment/app/FragmentManager;
    .end local v5    # "allowStateLoss$iv":Z
    .end local v6    # "$i$f$commit":I
    .end local v7    # "transaction$iv":Landroidx/fragment/app/FragmentTransaction;
    nop
...
.method public onPreferenceStartFragment(Landroidx/preference/PreferenceFragmentCompat;Landroidx/preference/Preference;)Z
    ...
    .line 87
    invoke-virtual {v0, v1, v3}, Landroidx/fragment/app/FragmentFactory;->instantiate(Ljava/lang/ClassLoader;Ljava/lang/String;)Landroidx/fragment/app/Fragment;
    ...
    .line 91
    .local v0, "frag":Landroidx/fragment/app/Fragment;
    ...
    .local v6, "$this$onPreferenceStartFragment_u24lambda_u2d0":Landroidx/fragment/app/FragmentTransaction;
    const/4 v7, 0x0
    ...
    invoke-virtual {v6, v8, v0}, Landroidx/fragment/app/FragmentTransaction;->replace(ILandroidx/fragment/app/Fragment;)Landroidx/fragment/app/FragmentTransaction;
    ...
    invoke-virtual {v6, v8}, Landroidx/fragment/app/FragmentTransaction;->addToBackStack(Ljava/lang/String;)Landroidx/fragment/app/FragmentTransaction;

    .line 98
    nop

    .line 321
    .end local v6    # "$this$onPreferenceStartFragment_u24lambda_u2d0":Landroidx/fragment/app/FragmentTransaction;
    ...
    .line 101
    .end local v0    # "frag":Landroidx/fragment/app/Fragment;
    :cond_1
    const/4 v0, 0x0
...
.method public onViewStateRestored(Landroid/os/Bundle;)V
    ...
    .line 357
    .local v2, "$this$commit$iv":Landroidx/fragment/app/FragmentManager;
    const/4 v3, 0x0
    ...
    .local v6, "$this$onViewStateRestored_u24lambda_u2d12_u24lambda_u2d11":Landroidx/fragment/app/FragmentTransaction;
    const/4 v7, 0x0
    ...
    invoke-virtual {v6, v8}, Landroidx/fragment/app/FragmentTransaction;->setReorderingAllowed(Z)Landroidx/fragment/app/FragmentTransaction;
    ...
    .line 362
    .end local v6    # "$this$onViewStateRestored_u24lambda_u2d12_u24lambda_u2d11":Landroidx/fragment/app/FragmentTransaction;
    ...
    .line 231
    .end local v2    # "$this$commit$iv":Landroidx/fragment/app/FragmentManager;
    .end local v3    # "allowStateLoss$iv":Z
    .end local v4    # "$i$f$commit":I
    .end local v5    # "transaction$iv":Landroidx/fragment/app/FragmentTransaction;
    nop
