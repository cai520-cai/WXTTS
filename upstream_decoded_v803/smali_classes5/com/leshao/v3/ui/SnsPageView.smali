.class public Lcom/leshao/v3/ui/SnsPageView;
.super Ljava/lang/Object;
.source "SnsPageView.java"
...
.method public static create(Landroid/content/Context;Landroid/app/Activity;)Landroid/view/View;
    ...
    invoke-virtual {v13, v1, v3, v0, v2}, Landroid/widget/LinearLayout;->setPadding(IIII)V

    .line 34
    const-string v0, "\u670b\u53cb\u5708\u589e\u5f3a"

    invoke-static {v8, v12, v0}, Lcom/leshao/v3/ui/SnsPageView;->sLabel(Landroid/content/Context;FLjava/lang/String;)Landroid/widget/TextView;
    ...
    .line 36
    invoke-static {v8, v12}, Lcom/leshao/v3/ui/SnsPageView;->makeCard(Landroid/content/Context;F)Landroid/widget/LinearLayout;

    move-result-object v14

    .line 37
    .local v14, "cardMain":Landroid/widget/LinearLayout;
    const-string v2, "\u542f\u7528\u670b\u53cb\u5708\u589e\u5f3a"

    const-string v3, "\u5173\u95ed\u540e\u6240\u6709\u5b50\u529f\u80fd\u5747\u4e0d\u751f\u6548"

    iget-boolean v4, v10, Lcom/leshao/v3/model/ModuleConfig;->snsFeaturesEnabled:Z

    new-instance v5, Lcom/leshao/v3/ui/SnsPageView$$ExternalSyntheticLambda0;

    invoke-direct {v5, v10, v9}, Lcom/leshao/v3/ui/SnsPageView$$ExternalSyntheticLambda0;-><init>(Lcom/leshao/v3/model/ModuleConfig;Landroid/content/SharedPreferences;)V
    ...
    invoke-static/range {v0 .. v6}, Lcom/leshao/v3/ui/SnsPageView;->switchRow(Landroid/content/Context;FLjava/lang/String;Ljava/lang/String;ZLandroid/widget/CompoundButton$OnCheckedChangeListener;Landroid/view/View$OnClickListener;)Landroid/widget/LinearLayout;
    ...
    .line 43
    invoke-static {v8, v12}, Lcom/leshao/v3/ui/SnsPageView;->candyDivider(Landroid/content/Context;F)Landroid/view/View;
    ...
    .line 47
    .local v15, "cardSub":Landroid/widget/LinearLayout;
    ...
    invoke-static/range {v0 .. v7}, Lcom/leshao/v3/ui/SnsPageView;->subSwitch(Landroid/content/Context;FLandroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLandroid/view/View$OnClickListener;)Landroid/widget/LinearLayout;
    ...
    new-instance v7, Lcom/leshao/v3/ui/SnsPageView$$ExternalSyntheticLambda1;

    invoke-direct {v7, v11, v9}, Lcom/leshao/v3/ui/SnsPageView$$ExternalSyntheticLambda1;-><init>(Landroid/app/Activity;Landroid/content/SharedPreferences;)V
...
.method static synthetic lambda$create$0(Lcom/leshao/v3/model/ModuleConfig;Landroid/content/SharedPreferences;Landroid/widget/CompoundButton;Z)V
    ...
    .line 39
    iput-boolean p3, p0, Lcom/leshao/v3/model/ModuleConfig;->snsFeaturesEnabled:Z

    invoke-virtual {p0, p1}, Lcom/leshao/v3/model/ModuleConfig;->save(Landroid/content/SharedPreferences;)V

    invoke-static {p3}, Lcom/leshao/v3/hook/SnsFeatures;->setEnabled(Z)V
...
.method static synthetic lambda$create$1(Landroid/app/Activity;Landroid/content/SharedPreferences;Landroid/view/View;)V
    ...
    .line 51
    invoke-static {p0, p1}, Lcom/leshao/v3/ui/ConfigPanels;->showSnsTimeOffset(Landroid/app/Activity;Landroid/content/SharedPreferences;)V

    return-void
.end method

.method static synthetic lambda$subSwitch$2(Landroid/content/SharedPreferences;Ljava/lang/String;Landroid/widget/CompoundButton;Z)V
    .locals 1
...
.method private static subSwitch(Landroid/content/Context;FLandroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLandroid/view/View$OnClickListener;)Landroid/widget/LinearLayout;
    ...
    .local v5, "checked":Z
    :goto_0
    new-instance v6, Lcom/leshao/v3/ui/SnsPageView$$ExternalSyntheticLambda2;

    invoke-direct {v6, p2, p3}, Lcom/leshao/v3/ui/SnsPageView$$ExternalSyntheticLambda2;-><init>(Landroid/content/SharedPreferences;Ljava/lang/String;)V
    ...
    invoke-static/range {v1 .. v7}, Lcom/leshao/v3/ui/SnsPageView;->switchRow(Landroid/content/Context;FLjava/lang/String;Ljava/lang/String;ZLandroid/widget/CompoundButton$OnCheckedChangeListener;Landroid/view/View$OnClickListener;)Landroid/widget/LinearLayout;
