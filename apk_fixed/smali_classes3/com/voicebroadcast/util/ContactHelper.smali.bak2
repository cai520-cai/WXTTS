...
.method public static getFriendList()Ljava/util/ArrayList;
    ...
    if-eqz v2, :cond_try_db

    instance-of v3, v2, Ljava/util/Set;

    if-eqz v3, :cond_try_db
    ...
    invoke-static {v5}, Lcom/voicebroadcast/util/ContactHelper;->getNickName(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 291
    if-eqz v6, :cond_use_wxid

    invoke-virtual {v6}, Ljava/lang/String;->isEmpty()Z

    move-result v7

    if-eqz v7, :cond_use_nick
...
.method public static getGroupList()Ljava/util/ArrayList;
    ...
    if-eqz v2, :cond_try_db_group

    instance-of v3, v2, Ljava/util/Set;

    if-eqz v3, :cond_try_db_group
    ...
    if-eqz v4, :cond_storage_group_done
    ...
    .line 320
    .local v6, "cache":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/String;>;"
    invoke-static {v5, v6}, Lcom/voicebroadcast/util/ContactHelper;->getGroupName(Ljava/lang/String;Ljava/util/HashMap;)Ljava/lang/String;
    ...
    .line 322
    if-eqz v7, :cond_use_roomid

    invoke-virtual {v7}, Ljava/lang/String;->isEmpty()Z

    move-result v8

    if-eqz v8, :cond_use_name

    :cond_use_roomid
    invoke-virtual {v0, v5}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    goto :goto_next_group
    ...
    .end local v6    # "cache":Ljava/util/HashMap;
    .end local v7    # "name":Ljava/lang/String;
    goto :goto_storage_group

    .line 326
    .end local v3    # "it":Ljava/util/Iterator;
    :cond_storage_group_done

    invoke-virtual {v0}, Ljava/util/ArrayList;->size()I

    move-result v2

    if-lez v2, :cond_try_db_group

    goto :goto_return_group
    ...
    .line 334
    const-string v2, "SELECT username, nickname FROM contact WHERE username LIKE \'%@chatroom\' AND username != \'\'"
